<%@ Page Title="" Language="C#" MasterPageFile="~/Recruitment/Admin/AdminMaster.master"
    AutoEventWireup="true" CodeFile="CanRoundMaster.aspx.cs" Inherits="Recruitment_User_CanRoundMaster" %>
            ...
            <div id="divView" style="display: block;" runat="server">
                <table cellpadding="0" cellspacing="0" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            Round Name
                            <asp:TextBox ID="txtRoundSearch" CssClass="input" runat="server"></asp:TextBox>
                            &nbsp;&nbsp;
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Round Name">
                                            ...
                                            <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top"
                                                Width="40%" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblRoundName" SkinID="gridLabel" runat="server" Text='<%# bind("Dsca") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtRoundName" CssClass="input" runat="server" Width="98%" MaxLength="50"
                                                    Text='<%# bind("Dsca") %>'></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtRoundName"
                                                    Display="None" SetFocusOnError="True" ToolTip="Enter Round Name" ValidationGroup="v"
                                                    Width="6px" ErrorMessage="Enter Round Name"></asp:RequiredFieldValidator>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td class="frm-rght-clr123">
                            <asp:TextBox runat="server" ID="txtRName" CssClass="input" Width="40%" MaxLength="50">
                            </asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtRName"
                                Display="None" SetFocusOnError="True" ToolTip="Enter Round Name" ValidationGroup="c"
                                Width="6px" ErrorMessage="Enter Round Name"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>

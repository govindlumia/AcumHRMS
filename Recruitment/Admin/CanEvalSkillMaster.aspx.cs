...
public partial class Recruitment_User_CanSkillMaster : System.Web.UI.Page
{
    ...
    protected void btnEnable_Click(object sender, EventArgs e)
    {
        ...
        {
            foreach (GridViewRow _Gr in grdResult.Rows)
            {
                EvalSkillParaENT ObjEvalSkillParaENT = new EvalSkillParaENT();
                RoundBusiness ObjRoundBusiness = new RoundBusiness();

                Label lblID = (Label)_Gr.FindControl("lblID");
            ...
            General.Alert("All parmaeters has been enabled", this);
            BindSkills();
        }
    }
    ...
    protected void btnDisable_Click(object sender, EventArgs e)
    {
        if (grdResult.Rows.Count > 0)
        {
            ...
            General.Alert("All parmaeters has been disabled", this);
            BindSkills();
        }
    }

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CanHistory.aspx.cs" Inherits="Recruitment_User_CanHistory" %>
...
<body>
    ...
    <fieldset id="fieldset" runat="server">
        <legend><b>Candidate History</b></legend>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td class="frm-rght-clr123">
                    <asp:Label ID="lblCanId" runat="server">
                    </asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <div id="dvResult" style="overflow: scroll; height: 500px;" runat="server">
                        <asp:GridView ID="GvCanHistory" runat="server" AutoGenerateColumns="False" BorderColor="#c9dffb"
                            BorderStyle="Solid" BorderWidth="1px" CellPadding="4" Font-Names="Arial" Font-Size="11px"
                            Width="100%" OnRowDataBound="GvCanHistory_RowDataBound">
                            <Columns>

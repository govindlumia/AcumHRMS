<%@ Page Language="C#" AutoEventWireup="true" CodeFile="productinformationview.aspx.cs"
    Inherits="productinformationview" %>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" class="text2">
                                                <a href="../upload/productinformation/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                                                    target="_blank" class="link-red">View/Download Product Information </a>
                                            </td>
                                        </tr>

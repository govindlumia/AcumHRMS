<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manualsview.aspx.cs" Inherits="manualsview" %>
            ...
            <tr>
                <td valign="top">
                    <asp:GridView ID="griddetails" runat="server" AutoGenerateColumns="False" CellPadding="2"
                        ...
                        EmptyDataText="No Manuals dockit has been posted" ToolTip="Manuals dockit posted"
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="2" title="Posted By : <%#DataBinder.Eval(Container.DataItem,"postedby")%>">
                                      <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" class="text2">
                                                <a href="../upload/manuals/<%#DataBinder.Eval(Container.DataItem,"upload")%>" target="_blank"
                                                    class="link-red">View/download Manuals </a>
                                            </td>
                                        </tr>

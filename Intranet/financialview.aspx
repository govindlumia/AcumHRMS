<%@ Page Language="C#" AutoEventWireup="true" CodeFile="financialview.aspx.cs" Inherits="financialview" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td valign="top">
                        <asp:GridView ID="gridfinancial" runat="server" AutoGenerateColumns="False" CellPadding="2"
                            CellSpacing="0" GridLines="None" PageSize="5" ShowHeader="False" Width="100%"
                            EmptyDataText="No financial has been posted" ToolTip="Financial posted" AllowPaging="True"
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2" title="Posted By : <%#DataBinder.Eval(Container.DataItem,"postedby")%>">
                                            ...
                                            <tr>
                                                ...
                                                <td width="98%" valign="top">
                                                    <a href="financialdetail.aspx?detail=<%#DataBinder.Eval(Container.DataItem,"id")%>"
                                                        class="link-red">

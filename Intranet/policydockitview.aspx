<%@ Page Language="C#" AutoEventWireup="true" CodeFile="policydockitview.aspx.cs"
    Inherits="policydockitview" %>
                ...
                <tr>
                    <td valign="top">
                        <asp:GridView ID="griddetails" runat="server" AutoGenerateColumns="False" CellPadding="2"
                            ...
                            EmptyDataText="No policy dockit has been posted" ToolTip="Policy dockit posted"
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2" title="Posted By : <%#DataBinder.Eval(Container.DataItem,"postedby")%>">
                                           <tr>
                                                <td width="2%" align="center" valign="middle">
                                                    <img src="../images/arrows1.gif" width="3" height="5" alt="" /></td>
                                                <td valign="top">
                                                    Posted On :
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" class="text2">
                                                    <a href="../upload/policydockit/<%#DataBinder.Eval(Container.DataItem,"upload")%>" target="_blank"
                                                        class="link-red">View/Download Policy Dockit </a>
                                                </td>
                                            </tr>

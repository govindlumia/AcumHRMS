<%@ Page Language="C#" AutoEventWireup="true" CodeFile="catalogview.aspx.cs" Inherits="catalogview" %>
                ...
                <tr>
                    <td valign="top">
                        <asp:GridView ID="griddetails" runat="server" AutoGenerateColumns="False" CellPadding="2"
                            ...
                            EmptyDataText="No catalog has been posted" ToolTip="company Catalog posted" AllowPaging="True"
                                    ...
                                    <ItemTemplate>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2" title="Posted By : <%#DataBinder.Eval(Container.DataItem,"postedby")%>">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" class="text2">
                                                    <a href="upload/catalogs/<%#DataBinder.Eval(Container.DataItem,"upload")%>" target="_blank"
                                                        class="link-red">View/Download Catalog </a>
                                                </td>
                                            </tr>
                                            <tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="isodocumentsview.aspx.cs"
    Inherits="isodocumentsview" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td height="22" valign="top" class="dot-line">
                        Company ISO Documents Details</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td valign="top">
                        <asp:GridView ID="griddetails" runat="server" AutoGenerateColumns="False" CellPadding="2"
                            ...
                            EmptyDataText="No iso documents has been posted" ToolTip="ISO Documents posted"
                                    ...
                                    <ItemTemplate>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2" title="Posted By : <%#DataBinder.Eval(Container.DataItem,"postedby")%>">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" class="text2">
                                                    <a href="upload/isodocuments/<%#DataBinder.Eval(Container.DataItem,"upload")%>" target="_blank"
                                                        class="link-red">View/Download ISO Document </a>
                                                </td>
                                            </tr>
                                            <tr>

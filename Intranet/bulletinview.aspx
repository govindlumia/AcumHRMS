<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bulletinview.aspx.cs" Inherits="bulletinview" %>
                ...
                <tr>
                    <td valign="top">
                        <asp:GridView ID="griddetails" runat="server" AutoGenerateColumns="False" CellPadding="2"
                            ...
                            EmptyDataText="No Bulletin document has been posted" ToolTip="HR document posted"
                                    ...
                                    <ItemTemplate>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2" title="Posted By : <%#DataBinder.Eval(Container.DataItem,"postedby")%>">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" class="text2">
                                                    <a href="upload/bulletindocuments/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                                                        target="_blank" class="link-red">View/Download Bulletin Document </a>
                                                </td>
                                            </tr>
                                            <tr>

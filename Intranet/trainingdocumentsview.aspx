<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trainingdocumentsview.aspx.cs"
    Inherits="trainingdocumentsview" %>
                ...
                <tr>
                    <td valign="top">
                        <asp:GridView ID="griddetails" runat="server" AutoGenerateColumns="False" CellPadding="2"
                            ...
                            EmptyDataText="No training documents has been posted" ToolTip="Training documents posted"
                                    ...
                                    <ItemTemplate>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2" title="Posted By : <%#DataBinder.Eval(Container.DataItem,"postedby")%>">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" class="text2">
                                                    <a href="../upload/trainingdocuments/<%#DataBinder.Eval(Container.DataItem,"upload")%>"
                                                        target="_blank" class="link-red">View/Download Training Document </a>
                                                </td>
                                            </tr>

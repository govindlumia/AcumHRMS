<%@ Page Title="" Language="C#" MasterPageFile="~/Appraisal/AppraisalMaster.master" AutoEventWireup="true" CodeFile="AllAppraisalStatusView.aspx.cs" Inherits="Appraisal_Reports_AllAppraisalStatusView" %>
                ...
                <td valign="top" class="blue-brdr-1">
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="txt01">Approved Appraisal Form
                            </td>
                            <td align="right">
                                    ...
                                    <td>
                                        <div id="dvResult" style="overflow: auto; height: 490px; border: 0px #000 solid;"
                                            ...
                                            <asp:GridView ID="grdKRAForm" runat="server" AllowPaging="True" Width="100%" HorizontalAlign="Left"
                                                ...
                                                BorderColor="#c9dffb" OnRowCommand="grd_RowCommand" OnPageIndexChanging="grdKRAForm_PageIndexChanging">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Status">
                                                        <ItemTemplate>
                                                            <%--<asp:Label ID="txtApproverComment" runat="server" Text='<%# UtilMethods.ConvertDateTimeddmmmmyyyy(Eval("CreatedOn")) %>'></asp:Label>--%>
                                                            <asp:Label ID="txtApproverComment" runat="server" Text='<%# Eval("ApproverCode") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                                        <ItemStyle CssClass="frm-rght-clr1234" Width="20%" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Action">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            &nbsp;
                                                            <asp:LinkButton ID="lnkPDF" runat="server" CommandName="Print" CommandArgument='<%# Eval("ID") %>' Text="Print PDF">
                                                            </asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

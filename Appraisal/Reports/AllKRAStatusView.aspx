<%@ Page Title="" Language="C#" MasterPageFile="~/Appraisal/AppraisalMaster.master" AutoEventWireup="true" CodeFile="AllKRAStatusView.aspx.cs" Inherits="Appraisal_Reports_AllKRAStatusView" %>
                ...
                <td valign="top" class="blue-brdr-1">
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="txt01">All Approved KRA Form
                            </td>
                            <td align="right"></td>
                        </tr>
                    </table>
                                    ...
                                    <td>
                                        <div id="dvResult" style="overflow: auto; height: 490px; border: 0px #000 solid;"
                                            ...
                                            <asp:GridView ID="grdAppraisalPeriod" runat="server" AllowPaging="True" Width="100%" HorizontalAlign="Left"
                                                ...
                                                BorderColor="#c9dffb" OnRowDataBound="grdAppraisalPeriod_RowDataBound" OnRowCommand="grdAppraisalPeriod_RowCommand" OnPageIndexChanging="grdAppraisalPeriod_PageIndexChanging">
                                                ...
                                                <Columns>
                                                    ...
                                                    <%-- <asp:TemplateField HeaderText="Self Comment">
                                                        <ItemTemplate>

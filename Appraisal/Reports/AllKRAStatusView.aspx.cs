...
public partial class Appraisal_Reports_AllKRAStatusView : BasePage<KRASetting>
{
    KRAMasterBAL _objBAL;
    public Appraisal_Reports_AllKRAStatusView()
    {
    ...
    void FillControls()
    {
        BindDataGridView(_objBAL.GetAllApprovalPending(SessionEmpCode, 2), grdAppraisalPeriod);
    }
    ...
    {        
        if (e.CommandName == "View")
        {
            ...
            Server.Transfer("../User/ViewKRASetting.aspx");
        }
    }

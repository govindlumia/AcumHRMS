...
public partial class Appraisal_Reports_CompetencyAndSkillReport : System.Web.UI.Page
{
    ReportsBAL objBAL;
    DataTable dt;
    ReportsEntity objEntity;

    public Appraisal_Reports_CompetencyAndSkillReport()
    {
    ...
    private void BindData()
    {
        try
        {
            ...
            dt = objBAL.CompetencySkillReport(objEntity);

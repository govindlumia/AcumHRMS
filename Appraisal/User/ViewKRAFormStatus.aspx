<%@ Page Title="" Language="C#" MasterPageFile="~/Appraisal/UserMaster.master" AutoEventWireup="true" CodeFile="ViewKRAFormStatus.aspx.cs" Inherits="Appraisal_User_ViewKRAFormStatus" %>
                ...
                <td valign="top" class="blue-brdr-1">
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="txt01">Appraisal Form Status
                            </td>
                            <td align="right">
                                    ...
                                    <td>
                                        <div id="dvResult" style="overflow: auto; height: 490px; border: 0px #000 solid;"
                                            ...
                                            <asp:GridView ID="grdKRAStatus" runat="server" AllowPaging="True" Width="100%" HorizontalAlign="Left"
                                                ...
                                                BorderWidth="1px" EmptyDataText="no record(s) found.." BorderColor="#c9dffb" OnRowCommand="grdAppraisalPeriod_RowCommand">                                                
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Appraisal ID">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblVID" runat="server" Text='<%# Eval("Id") %>'></asp:Label>
                                                        </ItemTemplate>

<%@ Page Title="View KRA Status" Language="C#" MasterPageFile="~/Appraisal/UserMaster.master"
    AutoEventWireup="true" CodeFile="ViewStatusKRA.aspx.cs" Inherits="Appraisal_User_ViewStatusKRA" %>
                ...
                <td valign="top" class="blue-brdr-1">
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="txt01">KRA Setting Status
                            </td>
                            <td align="right">
                                ...
                                <tr>
                                    <td>
                                        <div id="dvResult" style="overflow: auto; height: 490px; border: 0px #000 solid;"
                                            runat="server">
                                            <asp:GridView ID="grdKRAStatus" runat="server" AllowPaging="True" Width="100%" HorizontalAlign="Left"
                                                CellPadding="4" CaptionAlign="Left" AutoGenerateColumns="False" PageSize="10"
                                                BorderWidth="1px" EmptyDataText="no record(s) found.." BorderColor="#c9dffb"
                                                OnRowDataBound="grdAppraisalPeriod_RowDataBound" OnRowCommand="grdAppraisalPeriod_RowCommand">
                                                <%-- <PagerSettings PageButtonCount="100"></PagerSettings>--%>
                                                <Columns>
                                                    <asp:TemplateField HeaderText="KRA Id">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblKRAId" runat="server" Text='<%# Eval("ID") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Duration">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDuration" runat="server" Text='<%# Eval("KRADuration") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                                        <ItemStyle CssClass="frm-rght-clr1234" Width="20%" />
                                                    </asp:TemplateField>                                                  
                                                    ...
                                                    <asp:TemplateField HeaderText="Status">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblKRAStatus" runat="server" Text='<%# Eval("Status") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                                        <ItemStyle CssClass="frm-rght-clr1234" Width="15%" />
                                                    </asp:TemplateField>

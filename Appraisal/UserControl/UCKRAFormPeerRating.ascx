<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCKRAFormPeerRating.ascx.cs" Inherits="Appraisal_UserControl_UCKRAFormPeerRating" %>
...
<div>
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                                    <tr>                                                                       
                                                                        <td class="frm-rght-clr1234" width="30%">
                                                                            <asp:Label ID="lblIsPeerManager" Visible="false" runat="server" Text='<%# Bind ("IsPeerManager") %>'></asp:Label>
                                                                            <asp:Label ID="lblPeerCode" Visible="false" runat="server" Text='<%# Bind ("PeerManagerCode") %>'></asp:Label>
                                                                        ...
                                                                        <td class="frm-rght-clr1234" width="25%">
                                                                            ...
                                                                            <asp:DropDownList ID="ddlRating" runat="server">                                                                               
                                                                             ...
                                                                             <span id="isPeerText" runat="server" style="color: Red">*</span>                                                                                                                                                       
                                                                            </td>
    ...
    <div  class="modal-body">
              ...
              <div style="text-align:center; padding:20px; margin-bottom:20px"      >
                  <asp:TextBox ID="txtAddComment" Text= '<%# Bind ("Comment") %>' runat="server" Width="292px" Height="63px" style = "resize:none" TextMode="MultiLine" Rows="10" Columns="30" ></asp:TextBox>
              </div>
    </div>
    <div class="modal-footer">
        ...
        <tr>
            <td class="head-2" align="Right" valign="top">
                <asp:Button ID="btnSubmit" ValidationGroup="c" CssClass="button" OnClientClick ="return confirm_meth()" OnClick="SaveData"
                                ...
                                <columns>
                                    ...
                                    <asp:TemplateField HeaderText="Comments">
                                        <ItemTemplate>
                                            ...
                                            <a runat="server" id="allComments" href="" visible="false" class="link05">View</a>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                        <ItemStyle CssClass="frm-rght-clr1234" Width="70%" />

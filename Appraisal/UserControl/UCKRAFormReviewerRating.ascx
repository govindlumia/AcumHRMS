<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCKRAFormReviewerRating.ascx.cs" Inherits="Appraisal_UserControl_UCKRAFormReviewerRating" %>
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                                    <tr>                                                                        
                                                                        ...
                                                                        <td class="frm-rght-clr1234" width="15%">                                                                            
                                                                            ...
                                                                            <asp:Label ID="reviewerRatingLabel" visible="false" runat="server"  Text='<%# Bind ("ReviewerRating") %>'></asp:Label>                                                                                                                                             
                                                                            </td>
                                                                        <td class="frm-rght-clr1234" width="15%">
    ...
    <div class="modal-footer">
        ...
        <tr>
            <td class="head-2" align="Right" valign="top">
                <asp:Button ID="btnSubmit" CssClass="button" ValidationGroup="c" OnClientClick ="return confirm_meth()" OnClick="SaveData"
...
<ItemStyle CssClass="frm-rght-clr1234" Width="20%" />
                    ...
                    <tr>
                        <td height="20" valign="top" class="txt02">
                            <table width="100%">
                                <tr>
                                    <td width="27%" class="txt02" height="22">Training Required - Reviewer </td>
                                </tr>
                                <tr>
                                    <td>
                                        <table width="100%">
...
<ItemStyle CssClass="frm-rght-clr1234" Width="20%" />
                                                     ...
                                                     <asp:TemplateField HeaderText="Comments"><ItemTemplate>
                                                            <asp:Label ID="Label12" runat="server" Text='<%# Eval("Comments") %>'></asp:Label>                                                           
        ...
        <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="Job Detail">
            ...
            <ContentTemplate>
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td>
                             <a runat="server" id="a1" href="" class="link05">View Comments</a>
                        </td>
                    </tr>
                    <tr style="display:none;">
                        <td>
                             <a runat="server" id="a2" href="" class="link05">View Peer Manager's Comments</a>
                        </td>
                    </tr>                   
                </table>

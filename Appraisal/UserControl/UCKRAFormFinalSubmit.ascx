<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCKRAFormFinalSubmit.ascx.cs" Inherits="Appraisal_UserControl_UCKRAFormFinalSubmit" %>
                                                            ...
                                                            <HeaderTemplate>
                                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                                    <tr>                                                                       
                                                                        ...
                                                                        <td class="frm-lft-clr123" width="15%">Manager Rating</td>
                                                                        <td class="frm-lft-clr123" width="15%">Reviewer Rating</td>
                                                            ...
                                                            <ItemTemplate>
                                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                                    <tr>                                                                        
                                                                        ...
                                                                        <td class="frm-rght-clr1234" width="10%" align="center">                                                                            
                                                                            <asp:Label ID="txtWeightage" runat="server" Text='<%# UtilMethods.ConvertToDecimelUptoZero(Eval("Weightage")) %>'></asp:Label>
                                                                        </td>
                                                                         <td class="frm-rght-clr1234" width="10%" align="center">
                                                                        <asp:Label ID="lblSelfRating" runat="server" style="align-content:center;"  Text='<%# Bind ("SelfRating") %>'></asp:Label>
                                                                           ...
                                                                           <td class="frm-rght-clr1234" align="center" width="15%">
                                                                               <asp:HiddenField runat="server" id="hdnPeerCode" Value='<%# Bind ("PeerManagerCode") %>'></asp:HiddenField>
                                                                        <asp:Label ID="Label8" runat="server"  Text='<%# Bind ("ManagerRating") %>'></asp:Label>    
                                                                               <span id="isPeerText" runat="server" visible="false" style="color: Red">*</span>                                                                           
                                                                             <asp:Label ID="Label9" visible="false" runat="server"  Text='<%# Bind ("SelfComment") %>'></asp:Label>
                                                                             <asp:Label id="Label10" visible="false" runat="server"  Text='<%# Bind ("ManagerComment") %>'></asp:Label>
                                                                             </td>                                                                                   
                                                                        <td class="frm-rght-clr1234" align="center" width="15%">                                                                            
                                                                            <asp:Label ID="reviewerRatingLabel" runat="server"  Text='<%# Bind ("ReviewerRating") %>'></asp:Label>  
                                                                            <asp:DropDownList ID="ddlRating" Visible="False" runat="server">                                                                              
                                                                            </asp:DropDownList>                                                                                                                                                
                                                                            </td>
...
<a href="JavaScript:divexpandcollapse('<%# Eval("ID") %>');" style=" cursor:pointer;text-decoration: underline;float:left;margin-left:10px;"> Add </a>
    ...
    <div class="modal-footer">
        ...
        <tr id="trPDF" runat="server" visible="false">
            <td>
                <a runat="server" visible="false" id="printPDF" class="link05">Print PDF</a>
            </td>
        </tr>
        <tr>
            <td height="20" valign="top" class="txt02">
                <table width="100%" runat="server" id="tblUserComment">
                    <tr>
        ...
        <tr>
            <td class="head-2" align="Right" valign="top">
                <asp:Button ID="btnSubmit" CssClass="button" ValidationGroup="c" OnClientClick ="return confirm_meth()" Visible="False" OnClick="SaveData"
                    runat="server" Text="Submit" />
                <asp:Button ID="btnDraft" CssClass="button" OnClick="SaveData" OnClientClick ="return confirm_Draft()" Visible="False" runat="server" Text="Save as Draft" />
                <asp:Button ID="btnEdit" CssClass="button" Visible="False" runat="server" Text="Edit" OnClick="btnEdit_Click" />
                <asp:Button ID="btnClose" CssClass="button" Visible="False" OnClick="btnClose_Click" runat="server" Text="Close" />
            </td>
        </tr>
    </table>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="grdTrainingAttended" runat="server" Width="100%" HorizontalAlign="Left"
                                            ...
                                            <columns><asp:TemplateField HeaderText="Training"><ItemTemplate>
...
</asp:TemplateField><asp:TemplateField HeaderText="Duration"><ItemTemplate>
                                ...
                                <tr>
                                    <td width="27%" class="txt02" height="22">
                                        <asp:GridView ID="grdTrainingEmployee" runat="server" Width="100%" HorizontalAlign="Left"
                                            ...
                                            <columns><asp:TemplateField HeaderText="Training Type"><ItemTemplate>
...
<ItemStyle CssClass="frm-rght-clr1234" Width="20%" />
</asp:TemplateField><asp:TemplateField HeaderText="Training"><ItemTemplate>
...
<ItemStyle CssClass="frm-rght-clr1234" Width="20%" />
                                                ...
                                                <asp:TemplateField HeaderText="Recommended By"><ItemTemplate>
                                                            <asp:Label ID="Label11" runat="server" Text='<%# Eval("RecommendedBy") %>'></asp:Label>                                                                                                                 
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123">
                                                    <asp:DropDownList id="drpTrainingType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpTrainingType_SelectedIndexChanged"></asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                                <td width="20%" class="frm-lft-clr123">Training</td>
                                                <td class="frm-rght-clr123">
                                                    <asp:DropDownList id="drpTraining" runat="server"></asp:DropDownList></td>
                                            </tr>
                                            <tr>
...
<ItemStyle CssClass="frm-rght-clr1234" Width="20%" />
</asp:TemplateField><asp:TemplateField HeaderText="Action"><ItemTemplate>
...
<ItemStyle CssClass="frm-rght-clr1234" Width="20%" />
                                                     ...
                                                     <asp:TemplateField HeaderText="Comments"><ItemTemplate>
                                                            <asp:Label ID="Label25" runat="server" Text='<%# Eval("Comments") %>'></asp:Label>                                                           
...
<ItemStyle CssClass="frm-rght-clr1234" Width="80%" />
        ...
        <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="Job Detail">
            <HeaderTemplate>Promotion and Future Direction</HeaderTemplate>
            <ContentTemplate>
                <table width="100%">
                    <tr>
                        <td>
                            <asp:GridView ID="grdPromotion" runat="server" Width="100%" HorizontalAlign="Left"
                                ...
                                <columns>
                                    <asp:TemplateField HeaderText="Post Appraisal Actions">
                                        <ItemTemplate>
                                            <asp:Label ID="Label7" runat="server" ToolTip='<%# Eval("PromotionId") %>' Text='<%# Eval("Promotion") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                    ...
                                    <asp:TemplateField HeaderText="Comments">
                                        <ItemTemplate>
                                            <asp:Label ID="Label27" Visible="False"  runat="server" Text='<%# Eval("Comment") %>'></asp:Label>
                        ...
                        <tr>
                        <td>
                            <a runat="server" id="a1" class="link05">View Comments</a>
                        </td>
                    </tr>
                    <tr style="display:none;">
                        <td>
                            <a runat="server" id="a2" class="link05">View Peer Manager's Comments</a>
                        </td>
                    </tr>
                    <tr style="display:none;">
                        <td>
                            <a runat="server" id="a4" class="link05">View Reviewer's Comments</a>
                        </td>
                    </tr>
                    <tr style="display:none;">
                        <td>
                            <a runat="server" id="a3" visible="false" class="link05">View Management's Comments</a>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    </tr>
                    <tr id="trPromoted" runat="server" visible="False">
                        <td runat="server">
                            <table width="100%">
                                <tr>
                                    <td class="frm-lft-clr123" width="10%">IsPromoted
                                    </td>
                                    <td class="frm-rght-clr123">
                                        <asp:CheckBox runat="server" id="chkPromoted" AutoPostBack="True" OnCheckedChanged="chkPromoted_CheckedChanged"></asp:CheckBox>
                                        <asp:dropdownlist runat="server" visible="false" id="drpDesignation">
                                        </asp:dropdownlist>
                                    </td>
                                </tr>
                            </table>
        ...
        <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="Over all Rating">
            <HeaderTemplate>Over all Rating</HeaderTemplate>
            <ContentTemplate>
                <table width="100%">
                    <tr>
                        <td>
                            <asp:GridView ID="grdOverAllRating" runat="server" Font-Size="11px" Font-Names="Arial" AllowPaging="false"
                                Width="100%" AutoGenerateColumns="False" BorderWidth="0px" OnRowDataBound="grdOverAllRating_RowDataBound">
                                <columns><asp:TemplateField>
                                <ItemTemplate>
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="frm-rght-clr1234">
                                                <b>
                                                    <asp:Label ID="Label12" runat="server" Text='<%# Bind ("KRAHead") %>'></asp:Label>
                                                </b>
                                                (<asp:Label ID="Label13" runat="server" Text='<%# Bind ("WeightAge") %>'></asp:Label>)
                                            <asp:Label ID="Label14" runat="server" Visible="false" Text='<%# Bind ("KRAHeadID") %>'></asp:Label>
                                                <asp:Label ID="Label15" runat="server" Visible="false" Text='<%# Bind ("ID") %>'></asp:Label>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="grdDetails2" runat="server" Font-Size="11px" Font-Names="Arial" AllowPaging="false"
                                                            ...
                                                            <HeaderTemplate>
                                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                                    <tr>                                                                       
                                                                        ...
                                                                        <td class="frm-lft-clr123" width="15%">Manager Rating</td>
                                                                        <td class="frm-lft-clr123" width="15%">Reviewer Rating</td>
                                                                        <td class="frm-lft-clr123" width="15%">Over all Rating</td>
                                                                    </tr>
                                                                </table>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                                    <tr>                                                                        
                                                                        <td class="frm-rght-clr1234" width="30%">
                                                                            <asp:Label ID="Label16" Visible="false" runat="server" Text='<%# Bind ("KRASettingDetailId") %>'></asp:Label>
                                                                            <asp:Label ID="Label17" runat="server" Text='<%# Bind ("KRA") %>'></asp:Label>
                                                                        ...
                                                                        <td class="frm-rght-clr1234" align="center" width="10%">
                                                                         ...
                                                                         <td class="frm-rght-clr1234" align="center" width="10%">
                                                                        <asp:Label ID="Label19" runat="server"  Text='<%# Bind ("SelfRating") %>'></asp:Label>
                                                                              <asp:HiddenField runat="server" id="HiddenField1" Value='<%# Bind ("ManagerRating") %>'></asp:HiddenField>
                                                                             <asp:Label ID="Label20" visible="false" runat="server"  Text='<%# Bind ("SelfComment") %>'></asp:Label>
                                                                             <asp:Label id="Label21" visible="false" runat="server"  Text='<%# Bind ("ManagerComment") %>'></asp:Label>
                                                                             </td>                                                                         
                                                                           <td class="frm-rght-clr1234" align="center" width="15%">
                                                                               <asp:HiddenField runat="server" id="hdnOverPeer" Value='<%# Bind ("PeerManagerCode") %>'></asp:HiddenField>
                                                                        <asp:Label ID="Label22" runat="server"  Text='<%# Bind ("ManagerRating") %>'></asp:Label> 
                                                                               <span id="isPeerText1" runat="server" visible="false" style="color: Red">*</span>                                                                              
                                                                             <asp:Label ID="Label23" visible="false" runat="server"  Text='<%# Bind ("SelfComment") %>'></asp:Label>
                                                                             <asp:Label id="Label24" visible="false" runat="server"  Text='<%# Bind ("ManagerComment") %>'></asp:Label>
                                                                             </td>                                                                                   
                                                                        <td class="frm-rght-clr1234" align="center"  width="15%">                                                                            
                    ...
                    <tr>
                        <td align="right" style="padding-right:130px;">
                           <b> Over all Rating:</b> <asp:Label ID="lblRatingOverall" runat="server"  Text=""></asp:Label>    
                        </td>
                    </tr>
                </table>
            </ContentTemplate>

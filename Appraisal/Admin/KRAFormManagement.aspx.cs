...
public partial class Appraisal_Admin_KRAFormManagement : BasePage<KRAFormEntity>
{
     KRAFormBAL _objBAL;
     public Appraisal_Admin_KRAFormManagement()
    {
    ...
    void FillControls()
    {
        BindDataGridView(_objBAL.SelectKRAFormApproval(SessionEmpCode, 4), grdKRAForm);
    }

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_employee_arrear_salary.aspx.cs"
    Inherits="payroll_admin_view_employee_arrear_salary" %>
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="txt01" style="height: 16px">
                                                        View Employee Arrear Salary</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td class="frm-rght-clr123" width="27%">
                                                                    <asp:TextBox ID="txt_arrearrefno" runat="server" CssClass="input" Width="100px"></asp:TextBox></td>
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top">
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="TABLE1" onclick="return TABLE1_onclick()">
                                                                                    <tr>
                                                                                        <td valign="top" class="txt02" style="height: 22px">
                                                                                            Employees' List</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head-2" valign="top">
                                                                                            <div style="overflow: scroll; width: 719px; position: absolute;">
                                                                                                <asp:GridView ID="griddetail" runat="server" Font-Size="11px" Font-Names="Arial"
                                                                                                    CellSpacing="0" CellPadding="4" DataKeyNames="empcode" Width="135%" AutoGenerateColumns="False"
                                                                                                    BorderWidth="0px" AllowPaging="True" PageSize="50" EmptyDataText="No such arrear entry exists !"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:TemplateField>
                                                                                                            ...
                                                                                                            <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top"
                                                                                                                Width="10%" />
                                                                                                            <ItemTemplate>
                                                                                                                <a class="link05" href="view_employee_arrear_salary_detail.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>"
                                                                                                                    target="_self">View</a> | <a class="link05" href="edit_employee_arrear_salary.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>"
                                                                                                                        target="_self">Edit</a>
                                                                                                            </ItemTemplate>
                                                                                                        </asp:TemplateField>
                                                                                                    </Columns>
                                                                                ...
                                                                                <asp:SqlDataSource ID="SqlDataSource3" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>"
                                                                                    runat="server" SelectCommand="sp_payroll_fetch_arreardetail" SelectCommandType="StoredProcedure">
                                                                                </asp:SqlDataSource>
                                                                            </td>
                                                                        </tr>
                                                                    </table>

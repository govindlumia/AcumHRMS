                                        ...
                                        <td valign="top">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4" class="frm-rght-clr123">
                                                        <asp:DropDownList ID="dd_month_f" runat="server" CssClass="select" Width="90px" OnSelectedIndexChanged="dd_month_f_SelectedIndexChanged"
                                                            AutoPostBack="True">
                                                        </asp:DropDownList>
                                                        ...
                                                        <asp:DropDownList ID="dd_year_f" runat="server" CssClass="select" Width="90px" OnSelectedIndexChanged="dd_year_f_SelectedIndexChanged"
                                                            AutoPostBack="True">
                                                        </asp:DropDownList><asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="dd_year_f"
                                                            Display="Dynamic" ErrorMessage='<img src="../../images/error1.gif" alt="" />'
                                                            Operator="NotEqual" ToolTip="Select Year of Recovery" ValueToCompare="0"><img src="../../images/error1.gif" alt="" /></asp:CompareValidator></td>
                                                </tr>
                                                <tr>
                                                    <td height="5" colspan="5">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td width="19%" class="frm-lft-clr123">
                                                        Overtime(In Hours)</td>
                                                    <td width="31%" class="frm-rght-clr123">
                                                        <asp:TextBox ID="txt_ot" runat="server" CssClass="input">0</asp:TextBox>
                                                    ...
                                                    <td width="21%" class="frm-lft-clr123">
                                                        Overtime-H(In Hours)</td>
                                                    <td width="28%" class="frm-rght-clr123">
                                                        <asp:TextBox ID="txt_oth" runat="server" CssClass="input">0</asp:TextBox>
                                            ...
                                            <table width="40" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="100" align="center" valign="middle" style="height: 18px">
                                                        <asp:Button ID="btn_add" runat="server" CssClass="button" Text="Add" OnClick="btn_add_Click" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                            ...
                                            <asp:GridView ID="grid_overtimedetail" Width="100%" runat="server" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Overtime">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txt_ot1" CssClass="input" Text='<%# Bind("OVERTIME")%>' runat="server"></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField HeaderText="Overtime-H">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txt_oth1" CssClass="input" Text='<%# Bind("OVERTIME_H")%>' runat="server"></asp:TextBox>

                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="75%" class="frm-rght-clr123">
                                                    <asp:TextBox ID="txt_name"  CssClass="input2" runat="server" ToolTip="Payhead Name"
                                            ...
                                            <tr>
                                                ...
                                                <td width="75%" class="frm-rght-clr123">
                                                    <asp:DropDownList ID="dd_payheadtype" runat="server" CssClass="select" ValidationGroup="v"
                                                        Width="100px">
                                                        <asp:ListItem Value="7" Selected="True">Earnings</asp:ListItem>
                      ...
                      Text="No" /></td>
                                            ...
                                            <tr>
                                                <td width="25%" class="frm-lft-clr123">
                                                    &nbsp;</td>
                                                <td width="75%" class="frm-rght-clr123">
                                                    <asp:Button ID="btnsbmit" runat="server" Text="Submit" CssClass="button" OnClick="btnsbmit_Click" Width="100"

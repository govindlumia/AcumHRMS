<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tax_payer_detail_view.aspx.cs"
    Inherits="payroll_admin_tax_payer_detail_view" %>
                            ...
                            <td valign="top" class="blue-brdr-1">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="txt01">
                                            View/Update Tax Payer Detail Master</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                    ...
                                    <%--<tr>
                                        <td width="49%" height="22" valign="top" class="frm-lft-clr123">
                                            ...
                                            <asp:DropDownList ID="dd_branch" runat="server" CssClass="select" DataSourceID="SqlDataSource3"
                                                ...
                                                Width="130px" AutoPostBack="True" OnSelectedIndexChanged="dd_branch_SelectedIndexChanged">
                                            </asp:DropDownList>

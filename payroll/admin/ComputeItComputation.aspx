<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ComputeItComputation.aspx.cs"
    Inherits="payroll_admin_ComputeItComputation" %>
                                ...
                                <tr>
                                    <td valign="top" style="height: 123px; width: 719px;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td height="5" colspan="4" style="display: none;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="frm-lft-clr123" style="width: 11%">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="apply_reimbursement.aspx.cs"
    Inherits="payroll_admin_apply_reimbursement" %>
                                        ...
                                        <td valign="top" class="blue-brdr-1">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="txt01">
                                                        Application for Reimbursement</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td valign="top" style="height: 123px">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td width="30%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="rfvempcode" runat="server" ControlToValidate="txt_employee"
                                                                        ...
                                                                        ToolTip="Select Employee Code" ValidationGroup="v"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator></td>
                                                                <td width="45%">
                                                ...
                                                <tr>
                                                    <td width="25%" class="frm-lft-clr123">
                                                        Reimbursement Type<span style="color:Red">*</span></td>
                                                    <td width="75%" class="frm-rght-clr123">
                                                        <asp:DropDownList ID="dd_reimburse" runat="server" CssClass="select" Width="180px"
                                                ...
                                                <tr>
                                                    <td width="25%" class="frm-lft-clr123">
                                                        Reimbursement Ref. No.<span style="color:Red">*</span></td>
                                                    <td width="75%" class="frm-rght-clr123">
                                                        <asp:TextBox ID="txt_remb_ref" runat="server" CssClass="input2" size="30" Enabled="false" Text="Auto" ToolTip="Loan Reference ID"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td width="25%" class="frm-lft-clr123">
                                                        Reimbursement Amount<span style="color:Red">*</span></td>
                                                    <td width="75%" class="frm-rght-clr123">
                                                        ...
                                                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txt_remb_amount"
                                                            Display="Dynamic" ErrorMessage="Enter a valid amount" MaximumValue="9999999"
                                                            MinimumValue="0" Type="Currency" ValidationGroup="v"></asp:RangeValidator></td>
                                                </tr>
                                                <tr>
                                                    <td height="5" colspan="2">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="frm-rght-clr123">
                                                        <asp:FileUpload ID="upload_attach" runat="server" CssClass="input2" Width="287px" /></td>
                                                </tr>
                                                <tr>
                                                    <td height="5" colspan="2">
                                                    </td>

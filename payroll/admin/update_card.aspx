                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="75%" class="frm-rght-clr123">
                                                    <asp:TextBox ID="txtempcode" size="40" CssClass="input2" runat="server"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtempcode"
                                                        ...
                                                        Display="Dynamic" ToolTip="Enter Empcode"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td width="25%" class="frm-lft-clr123">
                                                    Old Card No</td>
                                                <td width="75%" class="frm-rght-clr123">
                                                    <asp:TextBox ID="txtoldcardno" runat="server" CssClass="input2" Width="223px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtoldcardno"
                                                        Display="Dynamic" ErrorMessage='<img src="../../images/error1.gif" alt="" />'
                                                        ToolTip="Enter old card no" ValidationGroup="v"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator></td>
                                            </tr>
                                            <tr>
                                                <td height="5" colspan="2">
                                                </td>
                                            ...
                                            <tr>
                                                <td width="25%" class="frm-lft-clr123">
                                                    New Card No</td>
                                                <td width="75%" class="frm-rght-clr123">
                                                    <asp:TextBox ID="txtnewcardno" runat="server" CssClass="input2" size="40"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtnewcardno"
                                                        ErrorMessage='<img src="../../images/error1.gif" alt="" />' ValidationGroup="v"
                                                        SetFocusOnError="True" ToolTip="Enter New Card No"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator></td>
                                            </tr>
                                            <tr>
                                                <td height="5" colspan="2">
                                                </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="employee_tds_detail.aspx.cs"
    Inherits="payroll_admin_employee_tds_detail" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="frm-lft-clr123">
                                                    Pick Employee</td>
                                                <td class="frm-rght-clr123" colspan="2">
                                                    <asp:TextBox ID="txt_employee" runat="server" CssClass="input" Width="118px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_employee"
                                                        Display="Dynamic" ErrorMessage='<img src="../../images/error1.gif" alt="" />'><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator><a
                                                            class="link05" href="JavaScript:newPopup1('../../leave/admin/pickemployee.aspx');"><span
                                                                style="color: #0000ff; text-decoration: underline">Pick Employee</span></a></td>
                                            </tr>
                                            <tr>
                                                <td height="5" colspan="3">
                                                </td>
                                            ...
                                            <tr>
                                                <td class="frm-lft-clr123">
                                                    TDS Amount</td>
                                                <td class="frm-rght-clr123" colspan="2">
                                                    <asp:TextBox ID="txt_tds_amnt" runat="server" CssClass="input" Width="118px"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td class="frm-lft-clr123">
                                                    Surcharge</td>
                                                <td class="frm-rght-clr123" colspan="2">
                                                    <asp:TextBox ID="txt_srchrg" runat="server" CssClass="input" Width="118px"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td class="frm-lft-clr123">
                                                    Education Cess</td>
                                                <td class="frm-rght-clr123" colspan="2">
                                                    <asp:TextBox ID="txt_education_cess" runat="server" CssClass="input" Width="118px"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td class="frm-lft-clr123">
                                                    Cheque/DD Number</td>
                                                <td class="frm-rght-clr123" colspan="2">
                                                    <asp:TextBox ID="txt_chk_no" runat="server" CssClass="input" Width="118px"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td height="5" colspan="3">
                                                </td>
                                            ...
                                            <tr>
                                                <td class="frm-lft-clr123">
                                                    BSR Code of Bank Branch</td>
                                                <td class="frm-rght-clr123" colspan="2">
                                                    <asp:TextBox ID="txt_bsr" runat="server" CssClass="input" Width="118px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_bsr"
                                                        Display="Dynamic" ErrorMessage='<img src="../../images/error1.gif" alt="" />'></asp:RequiredFieldValidator></td>
                                            </tr>
                                            <tr>
                                                <td height="5" colspan="3">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" colspan="2">
                                                    <asp:TextBox ID="txt_deposite" runat="server" CssClass="input" Width="93px"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td class="frm-lft-clr123">
                                                    Transfer Voucher Number</td>
                                                <td class="frm-rght-clr123" colspan="2">
                                                    <asp:TextBox ID="txt_transfer_boucher" runat="server" CssClass="input" Width="118px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_transfer_boucher"
                                                        Display="Dynamic" ErrorMessage='<img src="../../images/error1.gif" alt="" />'><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator></td>
                                            </tr>
                                            <tr>
                                                <td height="5" colspan="3">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123">
                                                    ...
                                                    <asp:Button ID="btn_reset" runat="server" CssClass="button" OnClick="btn_reset_Click"
                                                        Text="Reset" ValidationGroup="a" /></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>

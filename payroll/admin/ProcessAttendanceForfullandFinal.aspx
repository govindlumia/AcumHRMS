                                    ...
                                    <td valign="top" style="height: 123px; width: 719px;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 27%">
                                                    LWP<span style="color:Red">*</span> &nbsp;
                                                    <asp:TextBox ID="txtLWP" runat="server" CssClass="input" size="40" ToolTip="Employee Code"
                                                    
                                                    
                                                        Width="57px"></asp:TextBox>
                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLWP"
                                                    ErrorMessage='<img src="../../images/error1.gif" alt="" />' ToolTip="Enter LWP"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                    ...
                                                    <asp:TextBox ID="txtWorkingDays" runat="server" CssClass="input" size="40" ToolTip="Employee Code"
                                                        Width="121px"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtWorkingDays"

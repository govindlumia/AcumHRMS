                                    ...
                                    <td valign="top" class="blue-brdr-1" colspan="2">
                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td class="txt01">
                                                    Update Duty Roaster for Holiday / Week Off</td>
                                                <td align="right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="frm-rght-clr123">
                                                        <asp:Button ID="btnsv" OnClick="btnsv_Click" runat="server" Text="Update Holiday"
                                                            CssClass="button2" ValidationGroup="c"></asp:Button>&nbsp;
                                                        <asp:Button ID="btnweekoff" runat="server" CssClass="button2" OnClick="btnweekoff_Click"
                                                            Text="Update Week Off" ValidationGroup="c" /></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="process_employee_attendance_salary.aspx.cs"
                                            ...
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" colspan="2">
                                                    <asp:DropDownList ID="dd_month" runat="server" CssClass="select" AutoPostBack="True"
                                                        OnSelectedIndexChanged="dd_month_SelectedIndexChanged" Width="140px">
                                                    </asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                                <td height="5" colspan="3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" class="frm-rght-clr123">
                                                        &nbsp;<asp:Button ID="btn_procs_att" runat="server" CssClass="button2" Text="Process Attendance"
                                                            OnClick="btn_procs_att_Click" ValidationGroup="v" /></td>
                                                    <td align="left" class="frm-rght-clr123">
                                                        <asp:Button ID="btn_procs_salary" runat="server" CssClass="button2" Text="Process Salary"
                                                            OnClick="btn_procs_salary_Click" ValidationGroup="v" /></td>
                                                </tr>
                                    </td>
                                </tr>
                                <tr>

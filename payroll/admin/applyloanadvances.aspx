<%@ Page Language="C#" AutoEventWireup="true" CodeFile="applyloanadvances.aspx.cs"
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div id="divapply">
                                        ...
                                        <td valign="top" class="blue-brdr-1">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="txt01">
                                                        Application for Loan/Advances</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td valign="top" style="height: 123px">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td width="30%" class="frm-lft-clr123">
                                                        Loan/Advances Type<span style="color:Red">*</span></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="70%" class="frm-rght-clr123">
                                                        ...
                                                        <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txt_loanamnt"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="40%">
                                                                    <asp:Button ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="button"
                                                                        Text="Calculate" Width="82px"></asp:Button></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                    ...
                    <div id="divdetail" runat="server" visible="false" align="center">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">

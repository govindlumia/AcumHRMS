...
public partial class payroll_admin_sendmailtoallemployee : System.Web.UI.Page
{
    ...
    protected void bindempdetail()
    {
        ...
        ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["RossellConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_payroll_fetch_emp_detail_tdsReports", sqlparam);
    ...
    protected void btn_16_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow GridView in empgrid.Rows)
        {
            ...
            if (checkg.Checked)
            {
                ...
                sqlparm[1] = new SqlParameter("@empcode", strempcode);
    ...
    protected void btn_16D_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow GridView in empgrid.Rows)
        {
            ...
            if (checkg.Checked)
            {
                ...
                DataSet ds8 = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["RossellConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_payroll_fetch_Form16_Gross_Detail", sqlparm);
    ...
    protected void btn_12BA_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow GridView in empgrid.Rows)
        {
            ...
            if (checkg.Checked)
            {
                ...
                DataSet ds1 = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["RossellConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_payroll_employee_perquisite_12Ba_sum", sqlparm);
                ds1.Tables[0].TableName = "Form12BA";

                DataSet ds2 = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["RossellConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_payroll_employee_perquisite_Form12B", sqlparm);
    ...
    protected void btn_ack_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow GridView in empgrid.Rows)
        {
            ...
            if (checkg.Checked)
            {
                ...
                sqlparm[0] = new SqlParameter("@empcode", strempcode);
                sqlparm[1] = new SqlParameter("@fyear", stryear);
                DataSet ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["RossellConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_payroll_generate_ITR_Ack", sqlparm);
    ...
    protected void btn_itr_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow GridView in empgrid.Rows)
        {
            ...
            if (checkg.Checked)
            {
                ...
                DataSet ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["RossellConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_payroll_generate_ITR1", sqlparm);
                ds.Tables[0].TableName = "itr1";

                DataSet ds2 = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["RossellConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_payroll_employee_tds_detail", sqlparm);

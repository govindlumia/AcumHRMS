<%@ Page Language="C#" AutoEventWireup="true" CodeFile="declaration.aspx.cs" Inherits="payroll_admin_declaration" %>
                                    ...
                                    <tr>
                                        ...
                                        <td class="frm-rght-clr123" colspan="3">
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="30%">
                                                        <asp:TextBox ID="txt_employee" size="30" CssClass="input2" runat="server" 
                                                            ToolTip="Employee Code" ></asp:TextBox>

                            ...
                            <td valign="top" style="height: 5px">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr id="tramount" visible="false" runat="server">
                                        <td class="frm-lft-clr123" width="14%">
                                            Amount</td>
                                        <td colspan="5" class="frm-rght-clr123" width="15%">
                                            <asp:TextBox ID="txtamount" runat="server" CssClass="input">0</asp:TextBox>
                                            <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txtamount"
                                                ...
                                                MaximumValue="1000000" MinimumValue="0" Type="Double" ValidationGroup="v"></asp:RangeValidator></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>

                    ...
                    <tr>
                        <td valign="top">
                            <asp:GridView ID="griddetail" runat="server" Font-Size="11px" Font-Names="Arial"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Group Name">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt1" CssClass="input2" runat="server" Width="30%" Text='<%# Bind ("group_name") %>'></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Group Description">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt2" runat="server" CssClass="input2" Width="90%" Text='<%# Bind ("groupdescription") %>'></asp:TextBox>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
                                ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>" DeleteCommand="DELETE FROM [tbl_payroll_pfgroup_details] WHERE [id] = @original_id AND [group_name] = @original_group_name AND [groupdescription] = @original_groupdescription"

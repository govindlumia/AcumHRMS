                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="frm-rght-clr123">
                                                        ...
                                                        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="dd_month"
                                                            ...
                                                            Operator="NotEqual" ValueToCompare="0" ToolTip="Select Month"><img src="../../images/error1.gif" alt="" /></asp:CompareValidator></td>
                                                </tr>
                                                <tr>
                                                    <td height="5" colspan="2">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="frm-rght-clr123">
                                                        ...
                                                        <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="dd_year"
                                                            Display="Dynamic" ErrorMessage='<img src="../../images/error1.gif" alt="" />'
                                                            Operator="NotEqual" ValueToCompare="0" ToolTip="Select Year"><img src="../../images/error1.gif" alt="" /></asp:CompareValidator></td>
                                                </tr>
                                                <tr>
                                                    <td height="5" colspan="2">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="frm-lft-clr123">
                                                        Amount</td>
                                                    <td class="frm-rght-clr123">
                                                        <asp:TextBox ID="txt_amnt" runat="server" CssClass="input2" size="30"></asp:TextBox>

                                    ...
                                    <tr>
                                        <td valign="top" colspan="2">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td width="25%" class="frm-lft-clr123">
                                                        Arrear Reference No.</td>
                                                    <td width="75%" class="frm-rght-clr123">
                                                        <asp:TextBox ID="txt_arrear_ref" runat="server" CssClass="input2" size="30" ToolTip="Arrear Reference No."></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td width="25%" class="frm-lft-clr123">
                                                        Arrear Amount</td>
                                                    <td width="75%" class="frm-rght-clr123">
                                                        <asp:TextBox ID="txt_arrear_amount" runat="server" CssClass="input2" size="30" ToolTip="Arrear Amount"></asp:TextBox>
                                                        ...
                                                        <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txt_arrear_amount"
                                                            ...
                                                            ToolTip="Enter valid amount" Type="Currency">Enter valid amount</asp:RangeValidator></td>
                                                </tr>
                                                <tr>
                                                    <td height="5" colspan="2">
                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td class="frm-rght-clr1234">
                                                                    ...
                                                                    <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="dd_month"
                                                                        Display="Dynamic" ErrorMessage='<img src="../../images/error1.gif" alt="" />'
                                                                        Operator="NotEqual" ToolTip="Select Month" ValueToCompare="0" ValidationGroup="c"></asp:CompareValidator></td>
                                                                <td class="frm-rght-clr1234">

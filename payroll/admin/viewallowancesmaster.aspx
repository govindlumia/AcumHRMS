<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewallowancesmaster.aspx.cs"
    Inherits="payroll_admin_viewallowancesmaster" %>
                            ...
                            <td valign="top" style="height: 123px">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%" class="frm-rght-clr123">
                                            Rs.
                                            <asp:Label ID="lbl_taxrebate" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td height="5" colspan="2">
                                        </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_processed_attendance.aspx.cs"
    Inherits="payroll_admin_view_processed_attendance" %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="frm-rght-clr123">
                                <asp:DropDownList ID="dd_year" runat="server" CssClass="select">
                                </asp:DropDownList>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <td class="frm-rght-clr123" width="15%">
                                <asp:DropDownList ID="dd_designation" runat="server" CssClass="select" DataSourceID="SqlDataSource1"
                                    DataTextField="branch_name" DataValueField="branch_id" AppendDataBoundItems="True">

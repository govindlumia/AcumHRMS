                                ...
                                <tr>
                                    <td valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td width="75%" class="frm-rght-clr123">
                                                    ...
                                                    <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage='<img src="../../images/error1.gif" alt="" />'
                                                        ...
                                                        ToolTip="Value should be numeric ang greater than 0." Type="Currency" ValidationGroup="v"><img src="../../images/error1.gif" alt="" /></asp:RangeValidator></td>
                                            </tr>
                                            <tr>
                                                <td height="5" colspan="2">
                                                </td>
                                            ...
                                            <tr>
                                                <td width="25%" class="frm-lft-clr123" style="height: 30px">
                                                    &nbsp;</td>
                                                <td width="75%" class="frm-rght-clr123" style="height: 30px">
                                                    ...
                                                    <asp:Button ID="btn_reset" runat="server" CssClass="button" Text="Reset" ToolTip="Click to reset the entered details" /></td>
                                            </tr>
                                            <tr>
                    ...
                    <tr>
                        <td height="5" colspan="2">
                            <asp:GridView ID="griddetail" runat="server" Font-Size="11px" Font-Names="Arial"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Group Name">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt1" CssClass="input2" runat="server" Width="80%" Text='<%# Bind ("ptgrp_name") %>'></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Group Rate">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt2" runat="server" CssClass="input2" Width="90%" Text='<%# Bind ("ptgrp_rate") %>'></asp:TextBox>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
                                ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>" DeleteCommand="DELETE FROM [tbl_payroll_ptgroup_details] WHERE [id] = @original_id AND [ptgrp_name] = @original_ptgrp_name AND [ptgrp_rate] = @original_ptgrp_rate"

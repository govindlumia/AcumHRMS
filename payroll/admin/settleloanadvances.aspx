...
<body>
    <form id="form1" runat="server">
       <cc1:ToolkitScriptManager runat="server" ID="scriptmgr"></cc1:ToolkitScriptManager>
        <%--
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td height="20" valign="top" class="txt02">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="37%" class="txt02">
                                                            Search Employee Loan/Advances Detail</td>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td class="frm-rght-clr123" width="60%">
                                                            <asp:TextBox ID="txt_loanref" runat="server" CssClass="input" Width="90px"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="rfvloanref" runat="server" ControlToValidate="txt_loanref"
                                                                Display="Dynamic" ErrorMessage='<img src="../../images/error1.gif" alt="" />'
                                                                ToolTip="Enter Loan Reference ID" ValidationGroup="s"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator></td>
                                                                ...
                                                                <tr>
                                                                    <td valign="top">
                                                                        <div id="divloan" runat="server">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td valign="middle" class="txt02" style="height: 24px" colspan="4">
                                                                                        Applied Loan/Advances Detail</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="17%" class="frm-lft-clr123">
                                                                                        Employee Name</td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="frm-lft-clr123">
                                                                                        Loan Amount</td>
                                                                                    <td class="frm-rght-clr123">
                                                                                        <asp:Label ID="lbl_laonamnt" runat="server"></asp:Label></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td height="5" colspan="4">
                                                                                    </td>
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            <td class="frm-lft-clr123" width="33%">
                                                                Total Unpaid Installment Amount</td>
                                                            <td class="frm-rght-clr123" width="67%">
                                                                <asp:Label ID="lbl_tinstamnt" runat="server"></asp:Label>&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="frm-lft-clr123">
                                                                Settlement Date<span style="color:Red">*</span></td>
                                                            <td class="frm-rght-clr123">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="frm-rght-clr123">
                                                                <asp:TextBox ID="txt_detail" runat="server" CssClass="input2" Width="200px" TextMode="MultiLine"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="5" colspan="2">
                                                        ...
                                                        <tr>
                                                            <td class="frm-lft-clr123">
                                                                Pay all Unpaid Installments</td>
                                                            <td class="frm-rght-clr123">

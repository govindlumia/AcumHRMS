                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="frm-lft-clr123" width="21%">
                                                                    Tds</td>
                                                                <td class="frm-rght-clr123" width="27%">
                                                                    &nbsp;<asp:TextBox ID="txttdsrupees" runat="server" CssClass="input" Enabled="False">0.00</asp:TextBox></td>
                                                                <td class="frm-lft-clr123" width="21%">
                                                                    Interest</td>
                                                                <td class="frm-rght-clr123" width="27%">
                                                                    &nbsp;<asp:TextBox ID="txtinterest" runat="server" CssClass="input">0.00</asp:TextBox>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="frm-lft-clr123" width="21%">
                                                                    Others</td>
                                                                <td class="frm-rght-clr123" width="27%">
                                                                    &nbsp;<asp:TextBox ID="txtothers" runat="server" CssClass="input">0.00</asp:TextBox>&nbsp;
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="frm-lft-clr123" width="21%">
                                                                    Addl Amount</td>
                                                                <td class="frm-rght-clr123" width="27%">
                                                                    &nbsp;<asp:TextBox ID="txtaddlamount" runat="server" CssClass="input">0.00</asp:TextBox>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="frm-lft-clr123" width="21%">
                                                                    Total Amount</td>
                                                                <td class="frm-rght-clr123" width="27%">
                                                                    &nbsp;<asp:TextBox ID="txttotal" runat="server" CssClass="input" Enabled="False">0.00</asp:TextBox>&nbsp;</td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Upload_mobile_deduction.aspx.cs" Inherits="payroll_admin_Upload_mobile_deduction" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr id="Tr1" runat="server">
                                                ...
                                                <td align="left" colspan="2" class="frm-rght-clr123" style="width: 572px">
                                                    &nbsp;<asp:DropDownList ID="ddldeduction" runat="server" CssClass="select" DataSourceID="SqlDataSource21"
                                                        DataTextField="loan_name" DataValueField="id" OnDataBound="ddldeduction_DataBound"
                                                        Width="140px">
                                                    </asp:DropDownList>&nbsp;
                                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="ddldeduction"
                                                    ...
                                                    <asp:SqlDataSource ID="SqlDataSource21" runat="server" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>"
                                                        ProviderName="System.Data.SqlClient" SelectCommand="select id,loan_name from tbl_payroll_loan_advances where id not in (1,2)">
                                                    </asp:SqlDataSource>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    ...
                                                    <div id="uploadattendance" runat="server">
                                                        <fieldset class="fieldsetBorder">
                                                            <legend><b>Upload Deduction Type</b></legend>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td class="frm-lft-clr123">
                                                                        File Upload

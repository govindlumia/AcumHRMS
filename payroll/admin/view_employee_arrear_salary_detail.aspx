<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_employee_arrear_salary_detail.aspx.cs"
    Inherits="payroll_admin_view_employee_arrear_salary_detail" %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td valign="top" class="blue-brdr-1">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="txt01">
                                            View Employee Salary Arrear Detail</td>
                                        <td align="right">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="29%" class="txt02">
                                            View Employee Salary Arrear</td>
                                        <td width="71%" class="txt-red">
                        ...
                        <tr>
                            <td valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="22%" class="frm-lft-clr123">
                        ...
                        <tr>
                            <td valign="middle" class="txt02">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td>
                                            <div style="overflow-x: hidden; overflow-y: auto; height: 130px; width: 719px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="head-2">
                                                            <asp:GridView ID="griddetail" runat="server" Font-Size="11px" Font-Names="Arial"
                                                                CellPadding="4" Width="100%" AutoGenerateColumns="False" BorderWidth="0px" EmptyDataText="There is no paid Loan/Advances"

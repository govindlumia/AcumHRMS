                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="frm-rght-clr123" width="75%">
                                                                <asp:TextBox ID="txt_name" runat="server" ToolTip="Bonus Name" CssClass="input2"
                                                                    size="40" AutoPostBack="True" OnTextChanged="txt_name_TextChanged"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ToolTip="Enter Reimbursement Name"
                                                                    ...
                                                                    ControlToValidate="txt_name"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="frm-rght-clr123" width="75%">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ToolTip="Enter Alias Name"
                                                                    Display="Dynamic" ValidationGroup="v" ErrorMessage='<img src="../../images/error1.gif" alt="" />'
                                                                    ControlToValidate="txt_alias"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" height="5">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="frm-rght-clr123" width="75%">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ToolTip="Enter name to display in payslip"
                                                                    Display="Dynamic" ValidationGroup="v" ErrorMessage='<img src="../../images/error1.gif" alt="" />'
                                                                    ControlToValidate="txt_payslip"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" height="5">
                                                            </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_bonus_detail.aspx.cs"
    Inherits="payroll_admin_edit_bonus_detail" %>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td class="frm-rght-clr123">
                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td width="30%">
                                                                    <asp:TextBox ID="txt_employee" size="30" CssClass="input2" runat="server" ToolTip="Employee Code"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator ID="rfvempcode" runat="server" ControlToValidate="txt_employee"
                                                                        ...
                                                                        ToolTip="Select Employee Code"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator></td>
                                                                <td width="45%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="75%" class="frm-rght-clr123">
                                                        <asp:DropDownList ID="dd_bonus" runat="server" CssClass="select" Width="180px" DataSourceID="SqlDataSource1"
                                                        ...
                                                        <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="dd_bonus"
                                                            ...
                                                            Operator="NotEqual" ToolTip="Enter Loan/Advances Name" ValueToCompare="0"><img src="../../images/error1.gif" alt="" /></asp:CompareValidator>
                                                ...
                                                <tr>
                                                    <td width="25%" class="frm-lft-clr123">
                                                        Bonus Reference No.</td>
                                                    <td width="75%" class="frm-rght-clr123">
                                                        <asp:TextBox ID="txt_remb_ref" runat="server" CssClass="input2" size="30" ToolTip="Loan Reference ID"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td width="25%" class="frm-lft-clr123">
                                                        Bonus Amount</td>
                                                    <td width="75%" class="frm-rght-clr123">
                                                        <asp:TextBox ID="txt_remb_amount" runat="server" CssClass="input2" size="30" ToolTip="Loan Amount"></asp:TextBox>
                                                        ...
                                                        <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txt_remb_amount"
                                                            ...
                                                            ValidationGroup="c" Display="Dynamic"></asp:RangeValidator></td>
                                                </tr>
                                                <tr>
                                                    <td height="5" colspan="2">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td width="25%" class="frm-lft-clr123">
                                                        Sanction Date</td>
                                                    <td width="75%" class="frm-rght-clr123">
                                                        <asp:TextBox ID="txt_sanct" runat="server" CssClass="input2" Width="100px"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td width="25%" class="frm-lft-clr123">
                                                        Detail</td>
                                                    <td class="frm-rght-clr123">
                                                        <asp:TextBox ID="txt_detail" runat="server" TextMode="MultiLine" Width="219px"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td height="5" colspan="2">
                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td class="frm-rght-clr1234">
                                                                    ...
                                                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="dd_year"
                                                                        Display="Dynamic" ErrorMessage='<img src="../../images/error1.gif" alt="" />'
                                                                        Operator="NotEqual" ToolTip="Select year" ValueToCompare="0" ValidationGroup="c"></asp:CompareValidator></td>
                                                                <td class="frm-rght-clr1234">
                                                                ...
                                                                <td class="frm-rght-clr1234">
                                                                    <asp:TextBox ID="txt_dispers" runat="server" CssClass="input"></asp:TextBox>
                                                                    <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txt_dispers"
                                                                        ...
                                                                        MinimumValue="0" Type="Currency" ValidationGroup="c"></asp:RangeValidator>

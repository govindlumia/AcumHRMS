                                                            ...
                                                            <tr>
                                                                <td class="frm-rght-clr1234">
                                                                    ...
                                                                    <asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="dd_month"
                                                                        Display="Dynamic" ErrorMessage='<img src="../../images/error1.gif" alt="" />'
                                                                        Operator="NotEqual" ToolTip="Select Leave Name" ValueToCompare="0" ValidationGroup="c"></asp:CompareValidator></td>
                                                                <td class="frm-rght-clr1234">
                                                                ...
                                                                <td class="frm-rght-clr1234">
                                                                    ...
                                                                    <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txt_dispers"
                                                                        ...
                                                                        MinimumValue="0" Type="Currency" ValidationGroup="c" Display="Dynamic"></asp:RangeValidator></td>

...
public partial class payroll_admin_sendmailtoallemployee : System.Web.UI.Page
{
    ...
    protected void bindempdetail()
    {
        ...
        sqlparam[5].Value = (dd_month.Text=="" ? "0" : dd_month.SelectedItem.Text.ToString());
        ...
        ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["RossellConnectionString"].ConnectionString.ToString(), CommandType.StoredProcedure, "sp_payroll_fetch_emp_detail", sqlparam);
                ...
                if (checkg.Checked)
                {
                    ...
                    if (ds5.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (mailto.Trim() != "")
                        {
                            ...
                            ds = DBTask.ExecuteDataset(ConfigurationManager.ConnectionStrings["RossellConnectionString"].ToString(), CommandType.StoredProcedure, "payroll_payslip_emp", sqlparam);
                        ...
                        <tr>
					    <td align='center' class='blue-bg'>YKK INDIA PVT. LTD.</td>
				        </tr>
                        <tr>
...
<tr><td colspan='2' class='text'><b>Net Salary In Words :</b>" + abc.changeCurrencyToWords(Convert.ToDouble(ds.Tables[1].Rows[0]["ntotal"].ToString()));
                            ...
                            sw.Close();
                             ...
                             SmtpMail.SmtpServer = "125.19.53.131";
                            SmtpMail.Send(mail);
                        }
                    }
                }

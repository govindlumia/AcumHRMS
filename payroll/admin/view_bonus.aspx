                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td class="frm-rght-clr123">
                                <asp:DropDownList ID="dd_dept" runat="server" CssClass="select" Width="145px" DataSourceID="SqlDataSource2"
                        ...
                        <tr>
                            <td class="frm-lft-clr123" width="19%">
                                Bonus</td>
                            <td class="frm-rght-clr123" width="31%">
                                <asp:DropDownList ID="dd_reimb" runat="server" CssClass="select" DataSourceID="SqlDataSource4"
                        ...
                        <tr>
                            ...
                            <td colspan="4" align="right" valign="middle">
                                <asp:Button ID="btn_search" runat="server" CssClass="button" OnClick="btn_search_Click"
                                    Text="Search" />
                                <input id="Text1" class="button" value="Back" type="button" runat="server" onclick="javascript:history.go(-1)" /></td>
                        </tr>
                    </table>
                </td>
            </tr>

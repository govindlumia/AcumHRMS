                                    ...
                                    <td valign="top" class="blue-brdr-1">
                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td class="txt01" style="height: 16px">Allowances Master</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td height="20" valign="top" class="txt02">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td width="27%" class="txt02">View Allowances Details</td>
                                            ...
                                            <tr>
                                                <td class="head-2">
                                                    <asp:GridView ID="payheadgird" runat="server" Font-Size="11px" Font-Names="Arial"
                                                        ...
                                                        PageSize="30" OnRowDataBound="payheadgird_RowDataBound">
                                                        <Columns>
                                                        <asp:BoundField DataField="id" HeaderText="Id" SortExpression="id">
                                                                <ItemStyle CssClass="frm-rght-clr1234" Width="5%" />
                                                                <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="payhead_name" HeaderText="Allowances Name" SortExpression="payheadname">
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <a class="link05" href="viewallowancesmaster.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>"
                                                                        target="_self">View</a>| 
                                                                    <a class="link05" id="anchorEdit" runat="server" href=""
                                                                        target="_self">Edit</a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    ...
                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>"
                                                        SelectCommand="SELECT payhead_name,id,alias_name,(CASE WHEN payhead_type=0 THEN 'Earnings' WHEN payhead_type=1 THEN 'Deductions' ELSE 'N/A' END)payhead_type,name_inpayslip FROM tbl_payroll_payhead WHERE status=1 and type in(2,3) and id not in (0,1,2,3,4,5,7,8,9,10,11,13,17,23,37,47)"

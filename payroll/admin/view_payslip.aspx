<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_payslip.aspx.cs" Inherits="payroll_admin_view_payslip" %>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td height="20" valign="top" style="width: 719px">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="txt02" style="height: 13px">View Employee Pay slip</td>
                                ...
                                <tr>
                                    <td valign="top" style="height: 123px; width: 719px;">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="frm-lft-clr123" style="width: 11%">Employee Code<span style="color: Red">*</span></td>
                                                <td class="frm-rght-clr123" style="width: 27%">
                                                    <asp:TextBox ID="txt_employee" size="40" CssClass="input" runat="server" ToolTip="Employee Code"
                                                        Width="121px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="reqEmpcode" ValidationGroup="submit" runat="server" ControlToValidate="txt_employee"
                                            ...
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 27%">
                                                    <asp:Button ID="btnsbmit" runat="server" Text="Submit" ValidationGroup="submit" CssClass="button" OnClick="btnsbmit_Click"

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_bonusmaster_list.aspx.cs"
    Inherits="payroll_admin_view_bonusmaster_list" %>
                                ...
                                <tr>
                                    <td valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="head-2">
                                                    <asp:GridView ID="bonusgird" runat="server" Font-Size="11px" Font-Names="Arial" CellPadding="4"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top"
                                                                    Width="10%" />
                                                                <ItemTemplate>
                                                                    <a class="link05" href="view_bonus_master.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>"
                                                                        target="_self">View</a>| <a class="link05" href="edit_bonus_master.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>"
                                                                            target="_self">Edit</a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    ...
                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>"
                                                        SelectCommand="SELECT id,payhead_name,alias_name,(CASE WHEN payhead_type=0 THEN 'Earnings' WHEN payhead_type=1 THEN 'Deductions' ELSE 'N/A' END)payhead_type,name_inpayslip FROM tbl_payroll_bonus where status=1"

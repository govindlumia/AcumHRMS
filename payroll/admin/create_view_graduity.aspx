                                    ...
                                    <td valign="top" style="height: 123px">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="75%" class="frm-rght-clr123">
                                                    ...
                                                    <%--DataSourceID="SqlDataSource12"
                                                        DataTextField="financialyear" DataValueField="financialyear"--%>
                                            ...
                                            <tr>
                                                ...
                                                <td width="75%" class="frm-rght-clr123">
                                                    <asp:TextBox ID="txtdate" runat="server" CssClass="input2" Width="100px" ></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td width="75%" class="frm-rght-clr123">
                                                    ...
                                                    <asp:Button ID="btn_reset" runat="server" CssClass="button" Text="View" OnClick="btn_reset_Click" />&nbsp;<asp:Button
                                                        ID="btnexport" runat="server" CssClass="button" OnClick="btnexport_Click" Text="Export" /></td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <asp:GridView ID="empgrid" runat="server" Font-Size="11px" Font-Names="Arial" CellSpacing="0"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="DOJ">
                                                                    ...
                                                                    <ItemStyle Width="10%" HorizontalAlign="Left" VerticalAlign="Top" CssClass="frm-rght-clr1234" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl_doj_grid" runat="server" Text='<%# Bind ("emp_doj") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

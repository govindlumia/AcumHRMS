                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td class="frm-rght-clr123">
                                            <asp:Label ID="lbl_emp_per" runat="server"></asp:Label>%</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="frm-lft-clr123" style="width: 250px">
                                            Maximum amount</td>
                                        <td class="frm-rght-clr123">
                                            <asp:Label ID="lbl_emp_max" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td valign="top" height="5" colspan="2">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="frm-lft-clr123" style="width: 250px">
                                            Minimum amount</td>
                                        <td class="frm-rght-clr123">
                                            <asp:Label ID="lbl_emp_min" runat="server"></asp:Label></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="frm-lft-clr123" style="width: 250px">
                                            Employer PF contribution</td>
                                        <td class="frm-rght-clr123">
                                            <asp:Label ID="lbl_empr_Pf" runat="server"></asp:Label>%</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="frm-rght-clr123">
                                            <asp:Label ID="lbl_empr_pension" runat="server"></asp:Label>%</td>
                                    </tr>
                                    <tr>
                                        <td valign="top" height="5" style="width: 250px" colspan="2">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="frm-lft-clr123" style="width: 250px">
                                            Administrative charges PF<span class="txt06">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                                                &nbsp; &nbsp;&nbsp; (Account No. 02)</span></td>
                                        <td class="frm-rght-clr123">
                                            <asp:Label ID="lbl_empr_02" runat="server"></asp:Label>%</td>
                                    </tr>
                                    <tr>
                                        <td valign="top" height="5" style="width: 250px" colspan="2">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="frm-rght-clr123">
                                            <asp:Label ID="lbl_empr_21" runat="server"></asp:Label>%</td>
                                    </tr>
                                    <tr>
                                        <td valign="top" height="5" style="width: 250px" colspan="2">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="frm-rght-clr123">
                                            <asp:Label ID="lbl_empr_22" runat="server"></asp:Label>%</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td class="frm-rght-clr123">
                                            <asp:Label ID="lbl_esi_emp" runat="server"></asp:Label>%</td>
                                    </tr>
                                    <tr>
                                        <td valign="top" height="5" colspan="2">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="frm-rght-clr123">
                                            <asp:Label ID="lbl_esi_empr" runat="server"></asp:Label>%</td>
                                    </tr>
                                    <tr>
                                        <td valign="top" height="5" colspan="2">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="frm-lft-clr123" style="width: 250px">
                                            Cutoff Amount</td>
                                        <td class="frm-rght-clr123">
                                            <asp:Label ID="lbl_esi_cutoff" runat="server"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td valign="top" height="5" colspan="2">
                                        </td>

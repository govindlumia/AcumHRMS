                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="txt01">
                                            ...
                                            <asp:Label ID="lblfrmname" runat="server" CssClass="txt01"></asp:Label></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="75%" class="frm-rght-clr123">
                                            &nbsp;<asp:DropDownList ID="drpYear" runat="server" Width="221px" CssClass="select">
                                            ...
                                            <asp:CompareValidator ID="compareYear" runat="server" CssClass="select" ErrorMessage="Please Select Year"
                                                Width="189px" ControlToValidate="drpYear" Type="Integer" ValueToCompare="0" Operator="NotEqual"></asp:CompareValidator></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="frm-lft-clr123" style="width: 200px">
                                            Month</td>
                                        <td width="75%" class="frm-rght-clr123">
                                            &nbsp;<asp:DropDownList ID="drpMonth" runat="server" Width="221px" CssClass="select">
                                            ...
                                            &nbsp;<asp:CompareValidator ID="compareMonth" runat="server" ControlToValidate="drpMonth"
                                                CssClass="select" ErrorMessage="Please Select Month" Type="Integer" ValueToCompare="0"
                                                Width="189px" Operator="NotEqual"></asp:CompareValidator></td>
                                    </tr>
                                    <tr>
                                        <td height="5" colspan="2">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="frm-lft-clr123" style="width: 200px">
                                            PF Group</td>
                                        <td width="75%" class="frm-rght-clr123">
                                            &nbsp;<asp:DropDownList ID="drppfgroup" runat="server" Width="221px" CssClass="select"
                                                DataSourceID="SqlDataSource" DataTextField="group_name" DataValueField="id">
                                            </asp:DropDownList>
                                            <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>"
                                    ...
                                    <tr>
                                        <td class="frm-lft-clr123" style="width: 200px">
                                            Order By</td>
                                        <td width="75%" class="frm-rght-clr123">
                                            &nbsp;<asp:DropDownList ID="drporderby" runat="server" Width="221px" CssClass="select">
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%" class="frm-rght-clr123">
                                            ...
                                            <asp:Button ID="btn_reset" runat="server" CssClass="button" Text="Reset" /></td>
                                    </tr>
                                    <tr>
                                                            ...
                                                            <table border="0" cellspacing="0" cellpadding="0" style="width: 712px">
                                                                <tr>
                                                                    <td valign="middle" class="txt02" style="width: 617px; height: 24px;">
                                                                        ESI Half Yearly Challan</td>
                                                                    <td align="right" style="height: 24px;">
                                                                        <asp:LinkButton ID="LinkButton8" runat="server" OnClick="lnkshowreport_Click">Show Report</asp:LinkButton></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div id="divpfmonthlyreportmessage" runat="server" style="width: 712px" visible="false">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="width: 712px">
                                                                <tr>
                                                                    ...
                                                                    <td align="right" style="height: 24px;">
                                                                        <asp:LinkButton ID="LinkButton7" runat="server" OnClick="lnkshowreport_Click">Show Report</asp:LinkButton></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td valign="middle" class="txt02" colspan="1" style="width: 712px">
                                                        <div id="divesimonthlyreportmessage" runat="server" style="width: 712px" visible="false">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="width: 712px">
                                                                <tr>
                                                                    <td valign="middle" class="txt02" style="width: 617px; height: 24px;">
                                                                        Monthly ESI Report</td>
                                                                    <td align="right" style="height: 24px;">
                                                                        <asp:LinkButton ID="LinkButton6" runat="server" OnClick="lnkshowreport_Click">Show Report</asp:LinkButton></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div id="divesiform6message" runat="server" style="width: 712px" visible="false">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="width: 712px">
                                                                <tr>
                                                                    ...
                                                                    <td align="right" style="height: 24px;">
                                                                        <asp:LinkButton ID="LinkButton5" runat="server" OnClick="lnkshowreport_Click">Show Report</asp:LinkButton></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div id="divesiform5message" runat="server" style="width: 712px" visible="false">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="width: 712px">
                                                                <tr>
                                                                    ...
                                                                    <td align="right" style="height: 24px;">
                                                                        <asp:LinkButton ID="LinkButton4" runat="server" OnClick="lnkshowreport_Click">Show Report</asp:LinkButton></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td valign="middle" class="txt02" colspan="1" style="width: 712px">
                                                        <div id="divpfform12Amessage" runat="server" style="width: 712px" visible="false">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="width: 712px">
                                                                <tr>
                                                                    <td valign="middle" class="txt02" style="width: 617px; height: 24px;">
                                                                        Details of Contribution of employee, month by 25th</td>
                                                                    <td align="right" style="height: 24px;">
                                                                        <asp:LinkButton ID="LinkButton2" runat="server" OnClick="lnkshowreport_Click">Show Report</asp:LinkButton></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td valign="middle" class="txt02" colspan="1" style="width: 712px">
                                                        <div id="divpfform6Amessage" runat="server" style="width: 712px" visible="false">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="width: 712px">
                                                                <tr>
                                                                    <td valign="middle" class="txt02" style="width: 617px; height: 24px;">
                                                                        Yearly Statement of Contribution with Form 3A</td>
                                                                    <td align="right" style="height: 24px;">
                                                                        <asp:LinkButton ID="LinkButton3" runat="server" OnClick="lnkshowreport_Click">Show Report</asp:LinkButton></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td valign="middle" class="txt02" colspan="1" style="width: 712px">
                                                        <div id="divform5message" runat="server" style="width: 712px" visible="false">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="width: 712px">
                                                                <tr>
                                                                    <td valign="middle" class="txt02" style="width: 617px; height: 24px;">
                                                                        Details of newly enrolled employees</td>
                                                                    <td align="right" style="height: 24px;">
                                                                        <asp:LinkButton ID="lnkshowreport" runat="server" OnClick="lnkshowreport_Click">Show Report</asp:LinkButton></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </td>
                                                            ...
                                                            <table border="0" cellspacing="0" cellpadding="0" style="width: 712px">
                                                                <tr>
                                                                    <td valign="middle" class="txt02" style="width: 606px; height: 23px;">
                                                                        Details of resign employees</td>
                                                                    <td align="right" style="height: 23px;">
                                                                        <asp:LinkButton ID="LinkButton1" runat="server" OnClick="lnkshowreport_Click">Show Report</asp:LinkButton></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </td>

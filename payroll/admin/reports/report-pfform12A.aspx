<%@ Page Language="C#" AutoEventWireup="true" CodeFile="report-pfform12A.aspx.cs"
    Inherits="payroll_admin_reports_report_pfform12" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                         <%--   <tr>
                                                <td class="frm-lft-clr123" style="width: 11%">
                                                    Select Cost Center</td>
                                                <td align="left" class="frm-rght-clr123" style="width: 27%" colspan="2">
                                                    &nbsp;<asp:DropDownList ID="ddlbranch" runat="server" CssClass="select" DataSourceID="SqlDataSource21"
                                                        DataTextField="cost_center_name" DataValueField="cost_center" OnDataBound="ddlbranch_DataBound"
                                                        Width="140px">
                                                    </asp:DropDownList>&nbsp;
                                            ...
                                            <tr>
                                              ...
                                              <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 27%">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="reqEmpcode" runat="server" ControlToValidate="ddl_company"
                                                    ErrorMessage='<img src="../../../images/error1.gif" alt="" />' ToolTip="Select Company"><img src="../../../images/error1.gif" alt="" /></asp:RequiredFieldValidator>
                                                   </td>
                                            </tr>
                                            <tr>
                                                <td class="frm-lft-clr123" style="width: 11%">
                                            ...
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" style="width: 27%">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="dd_month"
                                                        Display="Dynamic" InitialValue="0" ErrorMessage='<img src="../../../images/error1.gif" alt="" />'

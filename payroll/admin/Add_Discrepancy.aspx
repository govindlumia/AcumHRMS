<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_Discrepancy.aspx.cs"
    Inherits="payroll_admin_Add_Discrepancy" %>
                                ...
                                <td style="height: 123px" valign="top">
                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="frm-rght-clr123" width="75%">
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>"
                                                    SelectCommand="SELECT financial_year financialyear FROM tbl_payroll_tax_master where id not in (1,2,3,4,5,6) order by id desc"
                                        ...
                                        <tr>
                                            ...
                                            <td class="frm-rght-clr123">
                                                <asp:TextBox ID="txtamount" runat="server" CssClass="input" size="40" ToolTip="amount Received"
                        ...
                        <asp:GridView ID="grid" runat="server" Width="100%" EmptyDataText="Sorry No Records Found"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Year">
                                    ...
                                    <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblFyear" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Fyear")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

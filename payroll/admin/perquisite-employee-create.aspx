                                ...
                                <tr>
                                    <td class="blue-brdr-1" valign="top">
                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                                            <tr>
                                                <td width="3%">
                                                    <img height="16" src="../../images/employee-icon.jpg" alt="" width="16" />
                                                </td>
                                                <td class="txt01">
                                            ...
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123" width="75%">
                                                    <asp:TextBox ID="txt_employee" size="40" CssClass="input" runat="server" ToolTip="Employee Code"
                                                        Width="88px" ValidationGroup="v"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123">
                                                    <asp:TextBox ID="txtperquisiteamtreceived" runat="server" CssClass="input" size="40"
                                                        ToolTip="Perquisite amount Received" Width="88px">0.0</asp:TextBox>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        <ContentTemplate>
                                                            <asp:GridView ID="grid" runat="server" Width="100%" EmptyDataText="Sorry No Records Found"
                                                                ...
                                                                CellPadding="4" BorderWidth="1px" DataKeyNames="perquisitedetail-id" AutoGenerateColumns="false"

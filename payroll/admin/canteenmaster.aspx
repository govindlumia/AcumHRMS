                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="25%" class="frm-lft-clr123">
                                            Breakfast Cost(Rs)</td>
                                        <td width="75%" class="frm-rght-clr123">
                                            <asp:TextBox ID="txtbrkfstcost" size="40" CssClass="input2" runat="server" Width="146px"
                                            ...
                                            <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtbrkfstcost"
                                                ErrorMessage="Enter valid Amount" MaximumValue="100" MinimumValue="1" ValidationGroup="v"
                                    ...
                                    <tr>
                                        <td width="25%" class="frm-lft-clr123">
                                            Lunch Cost(Rs)</td>
                                        <td width="75%" class="frm-rght-clr123">
                                            <asp:TextBox ID="txtlunchcost" runat="server" CssClass="input2" size="40" Width="146px"
                                            ...
                                            <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txtlunchcost"
                                                ErrorMessage="Enter valid Amount" MaximumValue="100" MinimumValue="1" ValidationGroup="v"
                                                Type="Double"></asp:RangeValidator></td>
                                    </tr>
                                    <tr>

            ...
            <ContentTemplate>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <td valign="top" class="blue-brdr-1">
                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td class="txt01">Employee Create Pay Structure Master</td>
                                ...
                                <tr>
                                    <td valign="top" style="height: 123px">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td class="frm-lft-clr123">Employee Code<span style="color: Red">*</span></td>
                                                <td class="frm-rght-clr123">
                                                    ...
                                                    <span id="pickemp" runat="server"><a href="JavaScript:newPopup1('../../pickempwithdata.aspx?MSS=0&HR=0&Emp=1&Con=txt_employee');"
                                            ...
                                            <tr>
                                                <td class="frm-lft-clr123">PF/ESI</td>
                                                <td class="frm-rght-clr123">&nbsp;
                                            ...
                                            <tr>
                                                <td class="frm-lft-clr123">Applied From<span style="color: Red">*</span></td>
                                                <td class="frm-rght-clr123">
               ...
               <tr visible="false">
                   <td class="frm-lft-clr123">
                       Applied To</td>
                   <td class="frm-rght-clr123">
                   <asp:DropDownList id="dd_month_t" runat="server" Width="90px" CssClass="select"></asp:DropDownList>
                   <asp:DropDownList id="dd_year_t" runat="server" Width="90px" CssClass="select"></asp:DropDownList>&nbsp;
                                            ...
                                            <tr>
                                                <td colspan="2" height="25" valign="middle" class="txt02">Create Pay Structure</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="frm-rght-clr123" style="width: 27%">
                                                        <asp:DropDownList ID="drpPayCalType" runat="server" Width="129px" AutoPostBack="True"
                                                            ...
                                                            <asp:ListItem Value="2">Computed on Basics%</asp:ListItem>
                                                    ...
                                                    <td colspan="2">
                                                        <div id="valuebase" runat="server" visible="true">
                                                            <table id="TABLE1" width="100%" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td class="frm-lft-clr123" style="width: 11%">Value Basis</td>
                                                                    <td class="frm-rght-clr123" style="width: 27%">
                                                                        <asp:TextBox ID="txtValueBase" runat="server" CssClass="input" size="40" ToolTip="Rate" MaxLength="10"
                                                                            onkeyup="checkNumericValueForCntrl(this)"
                                                    ...
                                                    <td colspan="2">
                                                        <div id="divbasic" runat="server" visible="true">
                                                            <table id="TABLE2" width="100%" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td class="frm-lft-clr123" style="width: 11%">Amount<span style="color: Red">*</span></td>
                                                                    <td class="frm-rght-clr123" style="width: 27%">
                                                                        <asp:TextBox ID="txtamount" runat="server" CssClass="input" size="40" ToolTip="Amount" MaxLength="10"
                                                                            onkeyup="checkNumericValueForCntrl(this)"
                                                                            Width="121px"></asp:TextBox>&nbsp;

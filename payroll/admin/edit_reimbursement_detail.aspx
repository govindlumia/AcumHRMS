...
<body>
    <form id="form1" runat="server">
       <cc1:ToolkitScriptManager runat="server" ID="tsm"></cc1:ToolkitScriptManager>
                                        ...
                                        <td valign="top" style="height: 123px">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="75%" class="frm-rght-clr123">
                                                        <asp:TextBox ID="txt_remb_amount" runat="server" onKeyUp="javascript:checkNumericValueForCntrl(this)" CssClass="input2" size="30" ToolTip="Loan Amount"></asp:TextBox>
                                                        ...
                                                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txt_remb_amount"
                                                            ...
                                                            Type="Currency" ValidationGroup="v"></asp:RangeValidator></td>
                                                </tr>
                                                <tr>
                                                    <td height="5" colspan="2">
                                                    </td>
                                                ...
                                                <tr>
                                                    <td width="25%" class="frm-lft-clr123">
                                                        Reimburse On</td>
                                                    <td width="75%" class="frm-rght-clr123">
                                                        <asp:DropDownList ID="dd_month" runat="server" CssClass="select" Width="90px" OnDataBound="dd_month_DataBound">
                                                        </asp:DropDownList>
                                                        <asp:DropDownList ID="dd_year" runat="server" CssClass="select" Width="90px" OnDataBound="dd_year_DataBound">
                                                        </asp:DropDownList>

        ...
        <table width="712" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td valign="middle" class="txt02 blue-brdr-1">
                    &nbsp;Report Tax Detail Employee Wise</td>
            </tr>
            <tr>
                        ...
                        <tr>
                            ...
                            <td class="frm-rght-clr123" width="18%">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_employee"
                                    ErrorMessage='<img src="../../images/error1.gif" alt="" />' Display="Dynamic"><img src="../../images/error1.gif" alt="" /></asp:RequiredFieldValidator></td>
                            <td class="frm-lft-clr123" width="10%">
                                Designation</td>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td class="frm-rght-clr123" width="10%">
                                                        &nbsp;<asp:Label ID="lblesttottax" runat="server"></asp:Label></td>
                                                    <td class="frm-lft-clr123" width="16%">
                                                        Est Balance Tax</td>
                                                    <td class="frm-rght-clr123" width="10%">
                                                        &nbsp;<asp:Label ID="lblestbaltax" runat="server"></asp:Label></td>
                                                    <td class="frm-lft-clr123" width="16%">
                                                        Gross Amt(M)</td>
                                                    <td class="frm-rght-clr123" width="10%">
                                                        &nbsp;<asp:Label ID="lblegrossamt" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        HRA Exemption</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lblehraexemption" runat="server"></asp:Label></td>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        Est Gross Amt(Y)</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lblestgrossamt" runat="server"></asp:Label></td>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        Est Taxable Income(Y)</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lblesttaxincome" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        80C</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lbl80c" runat="server"></asp:Label></td>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        80CCC</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lbl80ccc" runat="server"></asp:Label></td>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        80CCD</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lbl80ccd" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        80D</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lbl80d" runat="server"></asp:Label></td>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        80E</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lbl80e" runat="server"></asp:Label></td>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        80DD</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lbl80dd" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        80G</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lbl80g" runat="server"></asp:Label></td>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        Interest House</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lblinteresthouse" runat="server"></asp:Label></td>
                                                    <td class="frm-lft-clr123" width="10%">
                                                        Chapter 6A</td>
                                                    <td class="frm-rght-clr123" width="16%">
                                                        &nbsp;<asp:Label ID="lblchapter6a" runat="server"></asp:Label></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>

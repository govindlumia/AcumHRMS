                    ...
                    <tr>
                        <td valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <td valign="top" class="blue-brdr-1">
                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td class="txt01">
                                                    Attendance Cum Canteen Master</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="75%" class="frm-rght-clr123">
                                                    <asp:TextBox ID="txt_name" size="40" CssClass="input2" runat="server" Width="146px"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td width="25%" class="frm-lft-clr123">
                                                    Used For</td>
                                                <td width="75%" class="frm-rght-clr123">
                                                    &nbsp;<asp:DropDownList ID="ddlusedfor" runat="server" CssClass="select" Width="145px">
                                ...
                                <tr>
                                    <td class="txt02">
                                        Attendance-Canteen Code Mapping View</td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                        <asp:GridView ID="grid" runat="server" Font-Size="11px" Font-Names="Arial" CellPadding="4"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Used For">
                                                    ...
                                                    <EditItemTemplate>
                                                        <asp:DropDownList ID="ddlusedforg" runat="server" CssClass="select" Width="145px">
                                                            <asp:ListItem Value="A-I">Attendance-In</asp:ListItem>
                                                            <asp:ListItem Value="A-O">Attendance-Out</asp:ListItem>
                                                            <asp:ListItem Value="B">Canteen - Breakfast</asp:ListItem>
                                                            <asp:ListItem Value="L">Canteen - Lunch</asp:ListItem>

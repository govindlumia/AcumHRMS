<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProcessAttendanceForFandF.aspx.cs" Inherits="payroll_admin_ProcessAttendanceForFandF" %>
                                        ...
                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td class="txt01" style="height: 16px">
                                                    Process Attendance For Full And Final Settlement</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="frm-lft-clr123" style="width: 11%">
                                                    &nbsp;</td>
                                                <td class="frm-rght-clr123" style="width: 27%">
                                                    <asp:Button ID="btnsbmit" runat="server" Text="Process" CssClass="button" ToolTip="process attendance for F & F"

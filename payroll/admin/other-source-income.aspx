<%@ Page Language="C#" AutoEventWireup="true" CodeFile="other-source-income.aspx.cs"
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td valign="top" class="txt02">
                                        Create Other Source Income<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="25%" class="frm-lft-clr123">
                                                    Other Source Inc. Head</td>
                                                <td width="75%" class="frm-rght-clr123">
                                                    &nbsp;<asp:TextBox ID="txtothrsrcinc" runat="server" CssClass="input" Width="152px"></asp:TextBox>&nbsp;
                                ...
                                <tr>
                                    <td class="frm-rght-clr123" colspan="2">
                                        <asp:GridView ID="othrsrcincgird" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                            ...
                                            Width="100%" OnRowUpdating="othrsrcincgird_RowUpdating">
                                            <Columns>
                                                <asp:TemplateField HeaderText="Other Source Income Head">
                                                    ...
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="txtothrsrcincg" runat="server" CssClass="blue1" Text='<%#Bind("incomesource")%>'
                                                            ValidationGroup="grid" Width="213px"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Othr source inc Head can not be blank"
                                                            ControlToValidate="txtothrsrcincg" ValidationGroup="grid"></asp:RequiredFieldValidator>
                                                    </EditItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>"
                                            ProviderName="System.Data.SqlClient" DeleteCommand="DELETE FROM tbl_payroll_income_source_master WHERE id=@id"
                                            SelectCommand="SELECT id,incomesource from tbl_payroll_income_source_master ORDER BY id"
                                            UpdateCommand="update tbl_payroll_income_source_master set incomesource=@name where id=@id"

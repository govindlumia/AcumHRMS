<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewreimbursement.aspx.cs"
    Inherits="payroll_admin_viewreimbursement" %>
                                            ...
                                            <tr>
                                                <td class="head-2">
                                                    <asp:GridView ID="payheadgird" runat="server" Font-Size="11px" Font-Names="Arial"
                                                        ...
                                                        PageSize="30">
                                                        <Columns>
                                                            <asp:BoundField DataField="payhead_name" HeaderText="Reimbursement Name" SortExpression="payhead_name">
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top"
                                                                    Width="10%" />
                                                                <ItemTemplate>
                                                                    <a class="link05" href="viewreimbursementmaster.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>"
                                                                        target="_self">View</a>| <a class="link05" href="editreimbursementmaster.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>"
                                                                            target="_self">Edit</a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    ...
                                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>"
                                                        SelectCommand="SELECT id,payhead_name,alias_name,(CASE WHEN payhead_type=0 THEN 'Earnings' WHEN payhead_type=1 THEN 'Deductions' ELSE 'N/A' END)payhead_type,name_inpayslip FROM tbl_payroll_reimbursement where status=1  "

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewempdetail.aspx.cs" Inherits="Admin_company_empmaster"
    Title="Acuminous Software. : Employee View" %>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="frm-lft-clr123">
                                                                            Bank Name for Reimbursement</td>
                                                                        ...
                                                                        <td>
                                                                            &nbsp;</td>
                                                                        <td align="left" class="frm-lft-clr123">
                                                                            Account No for Reimbursement</td>
                                                                        <td align="left" class="frm-rght-clr123">
                                                                        ...
                                                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                            <tr>
                                                                                <td class="frm-lft-clr123" width="33%">
                                                                                    Father's Name</td>
                                                                                <td class="frm-rght-clr123">
                                                                                    <asp:Label ID="txt_f_f_name" runat="server"></asp:Label>&nbsp;</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td colspan="2" height="5">
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td class="frm-lft-clr123" width="33%">
                                                                                    Marital Status</td>
                                                                                <td class="frm-rght-clr123">
                                                                                    <asp:Label ID="ddlpersonalstatus" runat="server"></asp:Label>&nbsp;</td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                    <td valign="top">
                                                                        <table cellspacing="0" cellpadding="0" width="99%" align="right" border="0">
                                                                            <tr>
                                                                                <td class="frm-lft-clr123" width="43%">
                                                                                    Mother's Name</td>
                                                                                <td class="frm-rght-clr123">
                                                                                    <asp:Label ID="txt_m_fname" runat="server"></asp:Label>&nbsp;</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td colspan="2" height="5">
                                                                                </td>
                                                                                                ...
                                                                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="frm-lft-clr123" width="33%">
                                                                                                            Name</td>
                                                                                                        <td class="frm-rght-clr123" width="67%">
                                                                                                            &nbsp;<asp:Label ID="txt_sp_fname" runat="server"></asp:Label>&nbsp;</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td colspan="2" height="5">
                                                                                                        </td>
                                                                                                ...
                                                                                                <table cellspacing="0" cellpadding="0" width="99%" align="right" border="0">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="width: 86px" class="frm-lft-clr123">
                                                                                                            Date of Anniversary</td>
                                                                                                        <td class="frm-rght-clr123" width="57%">
                                                                                                            <asp:Label ID="txt_doa" runat="server"></asp:Label>&nbsp;</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td colspan="2" height="5">
                                                                                                        </td>
                                                                                        ...
                                                                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123" width="33%">
                                                                                                    Address 1</td>
                                                                                                <td class="frm-rght-clr123" width="67%">
                                                                                                    <asp:Label ID="txt_pre_add1" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123" width="33%">
                                                                                                    Address 2</td>
                                                                                                <td class="frm-rght-clr123" width="67%">
                                                                                                    <asp:Label ID="txt_pre_add2" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    City</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txt_pre_city" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    State</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txt_pre_state" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    Country</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txt_pre_country" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    Zip Code</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txt_pre_zip" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    Phone No.</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txt_pre_phone" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="lblmodeoftransport" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                        ...
                                                                                        <table cellspacing="0" cellpadding="0" width="99%" align="right" border="0">
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123" width="43%">
                                                                                                    Address 1</td>
                                                                                                <td class="frm-rght-clr123" width="57%">
                                                                                                    <asp:Label ID="txt_per_add1" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    Address 2</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txt_per_add2" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    City</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txt_per_city" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    State</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txt_per_state" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    Country</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txt_per_country" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    Zip Code</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txt_per_zip" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    Phone No.</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txt_per_phone" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="2" height="5">
                                                                                                </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="frm-lft-clr123">
                                                                                                    Pick Up Point</td>
                                                                                                <td class="frm-rght-clr123">
                                                                                                    <asp:Label ID="txtmodeoftransport" runat="server"></asp:Label>&nbsp;</td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                </tr>

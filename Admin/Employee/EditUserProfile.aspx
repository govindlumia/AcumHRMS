<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditUserProfile.aspx.cs" Inherits="Admin_Employee_EditUserProfile" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            // For hide the pick emp link 
            $(".link05").eq(0).hide().text();
            $(".link05").eq(1).hide().text();
            //hide the delete link from the grid  
            $("#TabContainer1_Tab_Job_Grid_approval").before(function () {
                $("#TabContainer1_Tab_Job_Grid_approval_ctl02_LinkButton1").hide();
            });
            //for diable the submit and cancel button link
            var r = $("#btngeneralsubmit,#btnCancel");
            $(r).attr("disabled", "true");
            $(r).css("color", "#B5B5B5");
            //for enable the submit and cancel button link
            $("#TabContainer1_TabPanel1_tab, #TabContainer1_TabPanel2_tab, #TabContainer1_TabPanel3_tab, #TabContainer1_TabPanel4_tab").click(function () {
                $(r).removeAttr('disabled').css("color", "#020950");
            });
            //click on job detail link diable the submit and cancel button link
            $("#TabContainer1_Tab_Job_tab").click(function () {
                $(r).attr("disabled", "true");
                $(r).css("color", "#B5B5B5");
            });
        });
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td class="frm-rght-clr123">
                                                                 <asp:TextBox ID="txt_login_id" runat="server" CssClass="blue1" Width="142px" MaxLength="20"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="5" colspan="2">
                                                            ...
                                                            <%--<tr>
                                                                ...
                                                                <td class="frm-rght-clr123" width="70%">
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtsalary"
                                                                        ...
                                                                        ToolTip="Enter Salary Calculation From Date" ValidationGroup="v" Width="6px"></asp:RequiredFieldValidator><cc1:CalendarExtender
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="frm-rght-clr123">
                                                        <asp:TextBox ID="Txt_rep_underwriter" runat="server"  ClientIDMode="Static" CssClass="blue1" Width="100px"></asp:TextBox><div
                                                            id="pick2" runat="server">
                                                            &nbsp;&nbsp; <a href="JavaScript:newPopup1('../../pickempwithdata.aspx?HR=0&MSS=0&Emp=1&Con=Txt_rep_underwriter');" class="link05">Pick
                                                                Employee</a>
                                                        </div>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <td colspan="2">
                                                        <asp:GridView ID="Grid_rep_approval" runat="server" Width="100%" CellPadding="4"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Approver Name">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("approvername") %>'></asp:Label></ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123"></HeaderStyle>
                                                                    <ItemStyle HorizontalAlign="Left" Width="15%" CssClass="frm-rght-clr1234"></ItemStyle>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Department">
                                                                ...
                                                                <%--<asp:TemplateField HeaderText="Business Unit">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("BU") %>'></asp:Label></ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123"></HeaderStyle>
                                                                    <ItemStyle HorizontalAlign="Left" Width="15%" CssClass="frm-rght-clr1234"></ItemStyle>
                                                                </asp:TemplateField>--%>
                                                                <asp:TemplateField HeaderText="Designation">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Label5" runat="server" Text='<%# Eval("designation") %>'></asp:Label></ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123"></HeaderStyle>
                                                                    <ItemStyle HorizontalAlign="Left" Width="15%" CssClass="frm-rght-clr1234"></ItemStyle>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Approval Level ">
                                                    ...
                                                    <td valign="top">
                                                        <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="frm-rght-clr123">
                                                                    <asp:TextBox ID="WardCircle" runat="server" CssClass="blue1" Width="142px" MaxLength="50"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="5" colspan="2">
                                        ...
                                        <td style="padding-left: 1px;">
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                ...
                                                                <asp:GridView ID="grid_Pro_education" runat="Server" Width="100%" OnRowDeleting="grid_Pro_education_RowDeleting"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="Education">
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <itemstyle width="15%" horizontalalign="Left" />
                                                                                 <asp:Label ID="Label6" Visible="false" runat="Server" Text='<%# Eval("id") %>'></asp:Label>
                                                                                <asp:Label ID="Label7" runat="Server" Text='<%# Eval("education") %>'></asp:Label></ItemTemplate>
                                                                                <EditItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Institute / University Name ">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Label8" runat="Server" Text='<%# Eval("school") %>'></asp:Label></ItemTemplate>
                                                                                <EditItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Month     Year">
                                                                            ...
                                                                            <asp:Label ID="Lbl_month" runat="server" Text='<%# Eval("month_from") %>'></asp:Label>
                                                                                <asp:Label ID="Label9" runat="Server" Text='<%# Eval("from_year") %>'></asp:Label> -
                                                                                <asp:Label ID="Lbl_monthto" runat="server" Text='<%# Eval("month_to") %>'></asp:Label>
                                                                                <asp:Label
                                                                                    ID="Label10" runat="Server" Text='<%# Eval("to_year") %>'></asp:Label></ItemTemplate>
                                                                                    <EditItemTemplate>
                                                ...
                                                CssClass="link04" Text="Edit  |" ToolTip="Edit" />
                                                                                ...
                                                                                <asp:LinkButton CssClass="link04" ID="LinkButton5" runat="server" CommandName="Delete"
                                                                                    Text="Delete"></asp:LinkButton></ItemTemplate>
                                                                                    <EditItemTemplate>
                                                                                    <asp:LinkButton ID="LinkButton6" runat="server" CausesValidation="false" OnClientClick="return confirm('Are you sure to update this entry?')"
                                                CommandName="Update" CssClass="link05" Text="Update" ToolTip="Update" />
                                                                                    </EditItemTemplate>
                                                                            <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123"></HeaderStyle>
                                                                            <ItemStyle HorizontalAlign="Center" Width="10%" CssClass="frm-rght-clr1234"></ItemStyle>
                                        ...
                                        <td style="padding-left: 1px;">
                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                ...
                                                                <asp:GridView ID="grid_exp" runat="Server" Width="100%" OnRowDeleting="grid_exp_RowDeleting"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="company Name">
                                                                            <ItemTemplate>
                                                                                <headerstyle horizontalalign="Left" />
                                                                                 <asp:Label ID="Label13" Visible="false" runat="Server" Text='<%# Eval("id") %>'></asp:Label>
                                                                       ...
                                                                       <asp:TemplateField HeaderText="Designation ">
                                                                            ...
                                                                            <HeaderStyle HorizontalAlign="Left" Width="10%" CssClass="frm-lft-clr123"></HeaderStyle>
                                                                            <EditItemTemplate>
                                                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Eval("Designation") %>'></asp:TextBox>
                                                                            </EditItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Left" Width="18%" CssClass="frm-rght-clr1234"></ItemStyle>
                                                                        </asp:TemplateField>
                                                ...
                                                CssClass="link04" Text="Edit  |" ToolTip="Edit" />
                                                                            ...
                                                                            <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123"></HeaderStyle>
                                                                            <EditItemTemplate>
                                                                                    <asp:LinkButton ID="LinkButton8" runat="server" CausesValidation="false" OnClientClick="return confirm('Are you sure to update this entry?')"
                                                CommandName="Update" CssClass="link05" Text="Update" ToolTip="Update" />
                                                                                    </EditItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" Width="10%" CssClass="frm-rght-clr1234"></ItemStyle>
                                                                        </asp:TemplateField>
                                                                ...
                                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                    <tr>
                                                                        ...
                                                                        <td class="frm-rght-clr123" width="64%">
                                                                            ...
                                                                            <asp:Image ID="Image2" runat="server" ToolTip="click to open calender" ImageUrl="../../images/clndr.gif">
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="frm-rght-clr123" width="64%">
                                                                                                    <asp:TextBox ID="txt_child_Dob" runat="server" CssClass="blue1" Width="100px"></asp:TextBox>&nbsp;<asp:Image
                                                                                                        ID="Image14" runat="server" ToolTip="click to open calender" ImageUrl="../../images/clndr.gif">
                                                                                                    </asp:Image>&nbsp;
                                                                                        ...
                                                                                        <asp:GridView ID="grid_child" runat="Server" Width="99%" OnRowDeleting="grid_child_RowDeleting"
                                                                                            ...
                                                                                            <Columns>
                                                                                                <asp:TemplateField HeaderText="Child Name ">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="Label14" runat="Server" Text='<%# Eval("child_name") %>'></asp:Label></ItemTemplate>
                                                                                                    <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123"></HeaderStyle>
                                                                                                    <ItemStyle HorizontalAlign="Left" Width="150px" CssClass="frm-rght-clr1234"></ItemStyle>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField HeaderText="Date of Birth">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="Label15" runat="Server" Text='<%# Eval("child_dob", "{0:dd-MMM-yyyy}") %>'></asp:Label></ItemTemplate>
                                                                                                    <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123"></HeaderStyle>
                                                                                                    <ItemStyle Width="200px" HorizontalAlign="Left" CssClass="frm-rght-clr1234"></ItemStyle>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField>
                                                                                                    <ItemTemplate>
                                                                                                        <asp:LinkButton ID="LinkButton9" runat="server" CommandName="Delete" CssClass="link04"
                                                                                                            Text="Delete"></asp:LinkButton></ItemTemplate>
                                                                                                    <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123"></HeaderStyle>
                                                                                                ...
                                                                                                <asp:GridView ID="grdTempClass" runat="server" AutoGenerateColumns="False" Width="100%"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        <asp:TemplateField HeaderText="Doccument Type">
                                                                                                            <ItemTemplate>
                                                                                                                <asp:Label ID="lblDocTypeid1" runat="server" Visible="false" Text=' <%#Eval("DocType")%>'></asp:Label><asp:Label
                                                                                                                    ID="lblDocTypeName1" runat="server" Text=' <%#Eval("DocTypeName")%>'>
                                                                                                                </asp:Label><asp:Label ID="lblCid" runat="server" Text=' <%#Eval("pid")%>' Visible="false"></asp:Label></ItemTemplate>
                                                                                                        </asp:TemplateField>
                                                                                                        <asp:TemplateField HeaderText="Document">
                                                                                                            <ItemTemplate>
                                                                                                                <asp:Label ID="lblUploadedDoc1" runat="server" Text='<%#Eval("UploadedDoc")%>' Visible="true"></asp:Label></ItemTemplate>
                                                                                                        </asp:TemplateField>
                                                                                                        <asp:TemplateField HeaderText="Description">
                                                                                                            <ItemTemplate>
                                                                                                                <asp:Label ID="lblDesc1" runat="server" Text='<%#Eval("Desc")%>' Visible="true"></asp:Label></ItemTemplate>
                                                                                                        </asp:TemplateField>
                                                                                                        <asp:CommandField ShowDeleteButton="True" HeaderText="Action">
                                                                                                            <ControlStyle CssClass="link01" />
                                                                                                        </asp:CommandField>

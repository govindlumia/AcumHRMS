<%@ Page Language="C#" AutoEventWireup="true" CodeFile="isodocuments.aspx.cs" Inherits="intranet_isodocuments" %>
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%" class="frm-rght-clr123">
                                                <asp:TextBox ID="txtsubject" runat="server" CssClass="blue1" Width="235px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator
                                                    ...
                                                    ValidationGroup="v" Display="Dynamic"><img src="../images/error1.gif" alt="*" /></asp:RequiredFieldValidator></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%" class="frm-rght-clr123">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtdescription"
                                                    ErrorMessage="Description" ValidationGroup="v" Display="Dynamic"><img src="../images/error1.gif" alt="*" /></asp:RequiredFieldValidator></td>
                                        </tr>
                                        <tr>
                                            <td height="5" colspan="2">
                                            </td>
                                                ...
                                                <asp:GridView ID="griddetails" runat="server" Width="100%" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Subject">
                                                            ...
                                                            <%-- <EditItemTemplate>
                                                                    <asp:TextBox ID="txtgsubject" CssClass="blue1" Text='<%#DataBinder.Eval(Container.DataItem, "subject")%>' runat="server" Width="100px"></asp:TextBox>
                                                                </EditItemTemplate>--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="Description">
                                                            ...
                                                            <%-- <EditItemTemplate>
                                                                    <asp:TextBox ID="txtgdescription" CssClass="blue1" Text='<%#DataBinder.Eval(Container.DataItem, "description")%>' TextMode="MultiLine" runat="server" Width="220px" Height="47px"></asp:TextBox>
                                                                </EditItemTemplate>--%>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Attached Document">
                                                            ...
                                                            <%--<EditItemTemplate>
                                                                <File_Uploader:File_Uploader ID="f_upload_rep1" runat="server" FileTypeRange="doc,pdf" MaxWeight="10485760" Required="true" Vgroup="update" />
                                                            </EditItemTemplate>--%>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>

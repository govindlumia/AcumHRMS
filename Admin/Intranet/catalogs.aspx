<%@ Page Language="C#" AutoEventWireup="true" CodeFile="catalogs.aspx.cs" Inherits="intranet_catalogs" %>
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%" class="frm-rght-clr123">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddltype"
                                                    ...
                                                    Display="Dynamic" Height="1px" Width="15px" ToolTip="Select Type"><img src="../images/error1.gif" alt="*" /></asp:RequiredFieldValidator></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%" class="frm-rght-clr123">
                                                <asp:TextBox ID="txtsubject" runat="server" CssClass="blue1" Width="235px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator
                                                    ...
                                                    ValidationGroup="v" Display="Dynamic" ToolTip="Add Subject"><img src="../images/error1.gif" alt="*" /></asp:RequiredFieldValidator></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%" class="frm-rght-clr123">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtdescription"
                                                    Display="Dynamic" ErrorMessage="Description" ValidationGroup="v" ToolTip="Add Description"><img src="../images/error1.gif" alt="*" /></asp:RequiredFieldValidator></td>
                                        </tr>
                                        <tr>
                                            <td height="5" colspan="2">
                                            </td>
                        ...
                        <asp:GridView ID="griddetails" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Description">
                                    <ItemStyle Width="38%" VerticalAlign="Top" CssClass="frm-rght-clr1234" />
                                    <HeaderStyle CssClass="frm-lft-clr123" />
                                    <ItemTemplate>
                                        <%#DataBinder.Eval(Container.DataItem, "description")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Catalog Upload">
                                    <ItemStyle Width="17%" VerticalAlign="Top" CssClass="frm-rght-clr1234" />
                                    <HeaderStyle CssClass="frm-lft-clr123" />
                                    <ItemTemplate>

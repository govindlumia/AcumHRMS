<%@ Page Language="C#" MasterPageFile="~/Admin/Intranet/IntranetMasterWithoutLink.master"
    AutoEventWireup="true" CodeFile="achievements.aspx.cs" Inherits="intranet_achievements" %>
                        ...
                        <td valign="top" class="blue-brdr-1">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td class="txt01">
                                        Intranet Press Release Master Form
                                    </td>
                                    <td align="right">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td valign="top" class="head-2">
                            <asp:GridView ID="achievementsdetails" runat="server" Width="100%" AutoGenerateColumns="False"
                                DataKeyNames="id" CellPadding="4" OnRowDataBound="achievementsdetails_RowDataBound"
                                BorderWidth="0px" OnPageIndexChanging="achievementsdetails_PageIndexChanging" OnRowCommand="achievementsdetails_RowCommand"
                                OnRowDeleting="achievementsdetails_RowDeleting" OnRowCancelingEdit="achievementsdetails_RowCancelingEdit"
                                OnRowEditing="achievementsdetails_RowEditing" OnRowUpdating="achievementsdetails_RowUpdating"
                                ToolTip="News Details" AllowPaging="True">
                                <Columns>
                                 ...
                                 <%--   <asp:TemplateField HeaderText="Run Status">
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <HeaderStyle CssClass="frm-lft-clr123" />
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkbtnedit" runat="server" CausesValidation="false" CommandName="Link_Update" CommandArgument='<%# Eval("ID") %>'

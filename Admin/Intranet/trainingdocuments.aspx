<%@ Page Language="C#" AutoEventWireup="true" CodeFile="trainingdocuments.aspx.cs"
    Inherits="intranet_trainingdocuments" MasterPageFile="~/Admin/Intranet/IntranetMasterWithoutLink.master"
                                    ...
                                    <%--<tr>
                                        ...
                                        <td width="75%" class="frm-rght-clr123">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddltype"
                                                ...
                                                Display="Dynamic"><img src="../../images/error1.gif" alt="*" /></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>--%>
                                    <tr>

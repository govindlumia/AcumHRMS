<%@ Page Language="C#" AutoEventWireup="true" Title="Bank Master" MasterPageFile="~/Admin/Company/CompanyMaster.master" CodeFile="Bankmaster.aspx.cs" Inherits="Admin_Company_Bankmaster" %>
                                                               ...
                                                               <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123" width="75%">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="rfvComplaintType" runat="server" ControlToValidate="drp_comp_name"
                                                                            Display="None" ValidationGroup="c" ErrorMessage="Please Select Company" InitialValue="0" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        ...
                                                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Txt_code"
                                                                            Display="None" SetFocusOnError="True" ToolTip="Enter Bank Code" ValidationGroup="c"
                                                                            ErrorMessage="Enter Bank Code" Width="6px"></asp:RequiredFieldValidator>--%>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2" height="5">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        <asp:TextBox ID="txt_grade_name" MaxLength="20" runat="server" CssClass="blue1" Width="142px"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_grade_name"
                                                                            Display="None" SetFocusOnError="True" ToolTip="Enter Bank Name" ValidationGroup="c"
                                                                            ErrorMessage="Enter Bank Name" Width="6px"></asp:RequiredFieldValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2" height="5">
                                                                   ...
                                                                   <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        <asp:TextBox ID="txt_grade_address" MaxLength="20" runat="server" CssClass="blue1" Width="142px"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_grade_address"
                                                                            Display="None" SetFocusOnError="True" ToolTip="Enter Bank Address" ValidationGroup="c"
                                                                            ErrorMessage="Enter Bank Address" Width="6px"></asp:RequiredFieldValidator>
                                                                    </td>
                                                                </tr>
                                                                 <tr>
                                                                    <td colspan="2" height="5">
                                                                 ...
                                                                 <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        <asp:TextBox ID="txt_grade_ifsc_code" MaxLength="20" runat="server" CssClass="blue1" Width="142px"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_grade_ifsc_code"
                                                                            Display="None" SetFocusOnError="True" ToolTip="Enter Bank IFSC Code" ValidationGroup="c"
                                                                            ErrorMessage="Enter Bank IFSC Code" Width="6px"></asp:RequiredFieldValidator>
                                                                    </td>
                                                                </tr>
                                                                 <tr>
                                                                    <td colspan="2" height="5">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td class="frm-rght-clr123" width="13%">
                                                                <asp:DropDownList ID="ddl_company" runat="server" CssClass="select" Width="100px" AutoPostBack="true">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td class="frm-lft-clr123" width="10%">
                                                                Bank Name
                                                        ...
                                                        <asp:GridView ID="Grid_Desg" runat="server" AllowPaging="True" Width="100%" HorizontalAlign="Left"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Bank Code" SortExpression="Bankcode">
                                                                   ...
                                                                   <asp:TemplateField HeaderText="Bank Address" SortExpression="BankAddress">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Bank IFSC Code" SortExpression="BankIFSCCode">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("bankifsccode") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                                                    <ItemStyle CssClass="frm-rght-clr1234" Width="30%" />
                                                                </asp:TemplateField>

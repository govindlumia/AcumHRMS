<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pickempwithdata.aspx.cs"
    Inherits="Employee_PickEmployee" Title="Employee Detail" %>
                    ...
                    <tr>
                        <td height="5" valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td valign="top">
                                        <table class="c1" width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td valign="top">
                                                    <table  width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>

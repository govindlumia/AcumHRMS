                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="grd_pending" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    AllowPaging="true" EmptyDataText="No Record(s) found" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Timesheet Period">
                                            <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" Width="130" />
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lbl_actname" Text='<%# Convert.ToDateTime(Eval("StartDate")).ToString("dd/MM/yyyy")+" to "+ Convert.ToDateTime(Eval("EndDate")).ToString("dd/MM/yyyy")%>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Center" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Activity">
                                            ...
                                            <ItemTemplate>
                                      <asp:LinkButton runat="server" ID="lnk_view" Text="view"></asp:LinkButton>
                                      <span style="padding-left:40px">
                                      <asp:LinkButton runat="server" ID="lnk_pass" Text="approve"></asp:LinkButton>
                                      </span>
                                            </ItemTemplate>
                                            <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Center" />
                                        </asp:TemplateField>

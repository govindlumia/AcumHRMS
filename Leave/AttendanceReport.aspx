<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AttendanceReport.aspx.cs"
    Inherits="Leave_admin_AttendanceReport" %>
                        ...
                        <td valign="top" colspan="2">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <%-- <td  align="right"><a href="leave-user.aspx" target="" class="txt-red">Back</a>
                                     </td>--%> 
                                  <%--  <td align="right">
                                        <asp:Button ID="btBack" runat="server" Text="Back" CssClass="button" OnClientClick="window.history.back()" />
                                    </td>--%>
                                </tr>
                                ...
                                <tr>
                                    <td valign="top" colspan="2">
                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td valign="bottom" class="frm-rght-clr123">
                                                                        ...
                                                                        &nbsp;<asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click"
                                                                            CssClass="link05" ValidationGroup="noone" Visible="false">Pick</asp:LinkButton>
                                                                        &nbsp;<br />
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            ...
                                                            <tr>
                                                                <td width="52%" class="frm-rght-clr123">
                                                                    <asp:RadioButtonList runat="server" ID="rbtn" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rbtn_OnSelectedIndexChanged">
                                                                        <asp:ListItem Value="0">View Process Data</asp:ListItem>
                                                                        <asp:ListItem Value="1">View Movement</asp:ListItem>
                                                                    </asp:RadioButtonList>
                                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="5" height="10" valign="middle" class="txt1">
                                                </td>
                                            </tr>
                                            <tr id="update" runat="server" visible="false" height="1000px">
                                                ...
                                                <td class="head-2" valign="top" colspan="5">
                                                    <div runat="server" id="dvViewMovement" visible="false" >
                                                        <asp:GridView ID="GridViewMovement" runat="server" Font-Size="11px" Font-Names="Arial"
                                                            ...
                                                            AllowPaging="True" PageSize="50" EmptyDataText="No data exists !" OnPageIndexChanging="GridViewMovement_PageIndexChanging">
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="Emp Code" Visible="false" >
                                                                    <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                                                    <ItemStyle Width="20%" HorizontalAlign="Left" VerticalAlign="Top" CssClass="frm-rght-clr1234" />
                                                                ...
                                                                <asp:TemplateField HeaderText="Date">
                                                                    ...
                                                                    <ItemStyle  HorizontalAlign="Left" VerticalAlign="Top" CssClass="frm-rght-clr1234" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbldateg" runat="server" Text='<%# Eval ("date", "{0:dd-MMM-yyyy}") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="InTime">
                                                                    ...
                                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" CssClass="frm-rght-clr1234" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblintime1" runat="server" Text='<%# Eval ("inTime", "{0:HH:mm tt}") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="OutTime">
                                                                    ...
                                                                    <ItemStyle  HorizontalAlign="Left" VerticalAlign="Top" CssClass="frm-rght-clr1234" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblouttime1" runat="server" Text='<%# Eval ("outtime", "{0:HH:mm tt}") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Terrace InTime1">
                                                                    <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123" />
                                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" CssClass="frm-rght-clr1234" />
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Terrace OutTime1">
                                                                    <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123" />
                                                                    <ItemStyle  HorizontalAlign="Left" VerticalAlign="Top" CssClass="frm-rght-clr1234" />
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Terrace InTime2">
                                                                    <HeaderStyle  CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="frm-rght-clr1234"
 />
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Terrace OutTime2">
                                                                    <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="frm-rght-clr1234"
                                                                        />
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Terrace InTime3">
                                                                    <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="frm-rght-clr1234"
                                                                        />
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Terrace OutTime3">
                                                                    <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left" />
                                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="frm-rght-clr1234"
                                                                         />
                                                                    <ItemTemplate>
                                                                 ...
                                                                 <asp:TemplateField HeaderText="Working Hours">
                                                                    ...
                                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="frm-rght-clr1234"
                                                                        />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="txtintime5" runat="server" Text='<%# Eval("TotWhours") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="frm-rght-clr123">
                                                                                <asp:DropDownList ID="dd_categoy" runat="server" CssClass="select2" DataSourceID="SqlDataSource2"
                                                                                    DataTextField="CategoryName" DataValueField="ID" OnDataBound="dd_categoy_DataBound"
                                                                                    Width="140px">
                                                                                </asp:DropDownList>

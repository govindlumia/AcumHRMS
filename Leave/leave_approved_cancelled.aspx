<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leave_approved_cancelled.aspx.cs" Inherits="leave_leave_approved_cancelled" %>
...
<tr>
           ...
           <%--             <asp:TemplateField HeaderText="Leave Status">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>" runat="server" SelectCommand="[sp_leave_fetchleavesummary_hr_cancelled]" SelectCommandType="StoredProcedure">
                <SelectParameters>

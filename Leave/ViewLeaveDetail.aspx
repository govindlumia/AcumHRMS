<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewLeaveDetail.aspx.cs" Inherits="Leave_ViewLeaveDetail" %>
...
<body>
    ...
    <div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td height="22" valign="top" class="txt02" colspan="2">
                    <table width="100%">
                        <tr>
                            <td width="27%" class="txt02" height="22">
                                Applied Leave
           ...
           <%-- <tr>
            ...
            <tr>
                <td align="right" valign="top" style="height: 18px">
                    <asp:Button ID="btn_modify" runat="server" CssClass="button" Text="Change Date" OnClick="btn_modify_Click" Visible="false"/>&nbsp;
                    <asp:Button ID="txt_cancel" runat="server" CssClass="button1" Text="Cancel leave"

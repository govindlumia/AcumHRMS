<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approvalgoodworkreward.aspx.cs" Inherits="leave_approvalgoodworkreward" %>
...
<asp:UpdateProgress ID="UpdateProgress1" AssociatedUpdatePanelID="UpdatePanel1" DisplayAfter="1" runat="server">
    ...
    <div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td class="txt01">
                Approve/Reject Good Work Reward</td>
            </tr>
        </table></td>
      </tr>
 ...
 <tr>
              ...
              <asp:GridView ID="applyotgrid" runat="server" Font-Size="11px" Font-Names="Arial" CellPadding="4" Width="100%" AutoGenerateColumns="False" BorderWidth="0px"  EmptyDataText="No Good Work Reward apply"
                ...
                <ItemTemplate>
                  ...
                  <asp:Label ID="l3" runat="server" Text ='<%# Bind ("total_hours") %>'></asp:Label>                  
                   ...
                   <ItemStyle Width="22%"  HorizontalAlign="Left" VerticalAlign="Top" CssClass= "frm-rght-clr1234"  /> 
                  <ItemTemplate>                  
                  <asp:Label ID="l211" runat="server" Text ='<%# Bind ("department_name") %>'></asp:Label>
                  </ItemTemplate>                   
                   </asp:TemplateField>               
                    <asp:TemplateField >
                    <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123"/> 
          ...
          <tr><td colspan="2"><asp:Button ID="btnapprove" runat="server" CssClass="button" Text="Approve" OnClick="btnapprove_Click" />
                &nbsp; &nbsp;
                <asp:Button ID="btnrejection" runat="server" CssClass="button" Text="Rejection" OnClick="btnrejection_Click" /></td></tr>
        </table></td>
      </tr>
    </table>
    </div>
         ...
         CellPadding="4"
          Font-Names="Arial"
           Font-Size="11px" OnPageIndexChanging="applyotviewgrid_PageIndexChanging" OnRowCancelingEdit="applyotviewgrid_RowCancelingEdit" OnRowDeleting="applyotviewgrid_RowDeleting" OnRowEditing="applyotviewgrid_RowEditing" OnRowUpdating="applyotviewgrid_RowUpdating">
                  ...
                  <EditItemTemplate>
                    <asp:TextBox ID="txtnoofhoursg" runat="server" Text='<%# Bind ("noofhour") %>' Width="73px"></asp:TextBox>
                ...
                <asp:LinkButton ID="lnk_edit" CssClass="link05" CommandName="Edit" runat="server" ValidationGroup="noone">Edit </asp:LinkButton>|
                 ...
                 <EditItemTemplate>
                    <asp:LinkButton ID="Button3" runat="Server" CommandName="Update"  Text="Update" ValidationGroup="grid"
                         CssClass="link05" /> | 

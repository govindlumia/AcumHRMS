<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubEmpAttReport.aspx.cs"
    Inherits="Leave_admin_SubEmpAttReport" %>
...
<body>
    ...
    <div class="header">
       ...
       document.getElementById('<%= this.adjustgrid.ClientID %>');
        ...
        <div runat="server" id="dv_toexport"></div>
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        ...
                                        <td valign="bottom" class="frm-rght-clr123">
                                            ...
                                            <cc1:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="img" TargetControlID="txt_frmdate"
                                                Format="dd-MMM-yyyy">
                                                            ...
                                                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td valign="bottom" class="frm-rght-clr123">
                                                                        ...
                                                                        &nbsp;
                                                                        <a href="JavaScript:newPopup1('../pickempwithdata.aspx?HR=0&MSS=1&Emp=0&Con=txt_employee');"
                                                                            class="link05">Pick Employee</a>&nbsp; &nbsp;<br />
                                                                    </td>
                                                    ...
                                                    <tr>
                                                        <td width="52%" class="frm-rght-clr123">
                                                            <asp:RadioButtonList runat="server" ID="rbtn" RepeatDirection="Horizontal" AutoPostBack="true"
                                                                OnSelectedIndexChanged="rbtn_OnSelectedIndexChanged">
                                            ...
                                            <asp:GridView ID="empgrid" runat="server" Font-Size="11px" Font-Names="Arial" CellSpacing="0"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="INTime(AM)">
                                                        ...
                                                        <ItemStyle Width="15%" HorizontalAlign="Left" VerticalAlign="Top" CssClass="frm-rght-clr1234" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="txtintime" runat="server" Text='<%# Eval("intime", "{0:HH:mm tt}") %>'
                                                    ...
                                                    <asp:TemplateField HeaderText="OUTTime(PM)">
                                                        ...
                                                        <ItemStyle Width="15%" HorizontalAlign="Left" VerticalAlign="Top" CssClass="frm-rght-clr1234" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="txtouttime" runat="server" Text='<%# Eval("outtime", "{0:HH:mm tt}") %>'

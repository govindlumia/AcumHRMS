<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewcompoff.aspx.cs" Inherits="leave_viewcompoff" %>
...
<body>
      ...
      <tr>
        <td valign="top" class="blue-brdr-1"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td class="txt01" style="height: 16px">View Comp-off Leave</td>
            </tr>
        </table></td>
      </tr>
      <tr>
   ...
   <tr>
      ...
      <tr>
        <td height="22" valign="top" class="txt02">&nbsp;Applied Comp-off</td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="right" valign="top" style="height: 18px">
            <asp:Button ID="btn_modify" runat="server"  CssClass="button" Text="Change Date" OnClick="btn_modify_Click" />&nbsp;
            <asp:Button ID="txt_cancel" runat="server" CssClass="button1" Text="Cancel leave" OnClick="btn_cancel_Click" />
            &nbsp;
        </td>
      </tr>
      <tr>

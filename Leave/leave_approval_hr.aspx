<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leave_approval_hr.aspx.cs" Inherits="Leave_Default" %>
            ...
            <tr>
                <td valign="top">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>"
                        runat="server" SelectCommand="sp_leave_fetchleavesummaryhr" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="50%" class="txt02" style="height: 13px">
                                            <asp:Label ID="Label1" runat="server" Text="Compensatory Credit Approval/Rejection"></asp:Label>
                                        </td>

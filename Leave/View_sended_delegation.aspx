<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_sended_delegation.aspx.cs" Inherits="Leave_Default" %>
           ...
           <td height="10">
            ...
            <tr>
              <td class="head-2">             
                  ...
                  <asp:GridView ID="del_grid"  runat="server" Font-Size="11px" Font-Names="Arial" CellPadding="3" CellSpacing="0"  DataKeyNames="id" Width="100%" AutoGenerateColumns="False" BorderWidth="1px" EmptyDataText="Sorry no record found" AllowPaging="True" PageSize="15" OnRowCommand="del_grid_RowCommand">
                        <Columns>

                            <asp:BoundField DataField="del_empcode" HeaderText="Emp Code" SortExpression="del_empcode" >
                            ...
                            <ItemStyle CssClass="frm-rght-clr1234" Width="19%" />
                            <HeaderStyle CssClass="grid-hd" HorizontalAlign="Left" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField  >
                            <HeaderStyle CssClass="grid-hd" HorizontalAlign="Left"/>                  
                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" CssClass= "frm-rght-clr1234" Width="5%"/> 
                            <ItemTemplate>
                            <asp:Button ID="btn_ter" runat="server" CommandArgument='<%#Eval("id")+ "," + Eval("del_empcode")%>' CommandName="send_terminate" CssClass="button3" Text="Stop" Enabled='<%#Bind ("status1") %>' />
                            </ItemTemplate>
                            </asp:TemplateField>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leave_not_applied.aspx.cs" Inherits="leave_admin_leave_not_applied" %>
...
<%--<asp:SqlDataSource ID="SqlDataSource3" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>" runat="server" SelectCommand="sp_payroll_fetch_emp_detail" SelectCommandType="StoredProcedure">
                                <SelectParameters>

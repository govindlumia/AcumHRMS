<%@ Page Language="C#" AutoEventWireup="true" CodeFile="over_write_attendance_update.aspx.cs" Inherits="leave_admin_over_write_attendance_update" %>
...
<body>
 ...
 <asp:ScriptManager ID="leave" runat="server" AsyncPostBackTimeout="600">
        </asp:ScriptManager>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="2" valign="top"><h3>
              Overwrite Attendance</h3></td>
        </tr>
        <tr>
          <td colspan="2" valign="top" style="height: 5px" class="txt-red" align="left"> <span id="message" runat="server"></span>
              &nbsp;</td>
        </tr>
       ...
       <tr>
          ...
          <td valign="middle" class="frm-lft-clr123">
              From Date (<img src="../images/error1.gif" alt="" />)</td>
          <td valign="bottom" class="frm-rght-clr123">
              ...
              <td valign="middle" class="frm-lft-clr123">
                      To Date (<img src="../images/error1.gif" alt="" />)</td>
              <td valign="bottom" class="frm-rght-clr123">
       ...
       <tr>
        <td valign="middle" class="frm-lft-clr123">
              Emp Code (<img src="../images/error1.gif" alt="" />)</td>
          <td valign="bottom" class="frm-rght-clr123">
              <asp:TextBox ID="txt_employee" runat="server" CssClass="input2"></asp:TextBox>
              ...
              &nbsp;<asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="link05" ValidationGroup="noone">Pick</asp:LinkButton>
              &nbsp;<br />
              (e.g. '97064' ,'00043' )&nbsp;
          </td>
          <td valign="bottom" class="frm-rght-clr123" align="right" >  
              <asp:Button ID="Button3" runat="server" CssClass="button1" OnClick="Button1_Click" Text="Fetch Attendance" />
          </td>
          <td valign="bottom" class="frm-rght-clr123" align="right" runat="server" id="an">  
              <asp:Button ID="Button2" runat="server" CssClass="button1" OnClick="Button2_Click" Text="Update Attendance" />
          </td>
       </tr>
       <tr><td colspan="4" height="10" valign="middle" class="txt1"></td></tr>

       <tr id="update" runat="server" visible="false">
       
        <td class="head-2" valign="top" colspan="4" >          
        <asp:GridView ID="empgrid" runat="server" Font-Size="11px" Font-Names="Arial"  CellSpacing="0" CellPadding="3" Width="100%" AutoGenerateColumns="False" BorderWidth="0px"  AllowPaging="True" PageSize="100" EmptyDataText="No data exists !" OnPageIndexChanging="empgrid_PageIndexChanging">
        <Columns>
            ...
            <EditItemTemplate>
            <asp:DropDownList id="ddlrunstatusg" runat="server" Width="75px" SelectedValue='<%#Bind("mode")%>' CssClass="select1" Height="20px">
            <asp:ListItem Value="0">P</asp:ListItem>
            <asp:ListItem Value="1">A</asp:ListItem>
            <asp:ListItem Value="2">H</asp:ListItem>
            <asp:ListItem Value="3">W</asp:ListItem>
             ...
             <asp:TemplateField HeaderText="Time(e.g. 00:00:00 AM)">
                    <HeaderStyle HorizontalAlign="Left" CssClass="frm-lft-clr123"/>              
                    <ItemStyle Width="25%"  HorizontalAlign="Left" VerticalAlign="Top" CssClass= "frm-rght-clr1234"  /> 
                    <ItemTemplate>                  
                        <asp:TextBox ID="txtintime" runat="server" Text='<%# Eval("intime") %>' CssClass="input2" Width="81px"></asp:TextBox> ||
                        <asp:TextBox ID="txtouttime" runat="server" Text='<%# Eval("outtime") %>' CssClass="input2" Width="78px"></asp:TextBox>
                    </ItemTemplate>
                    </asp:TemplateField> 
                    
            <asp:TemplateField HeaderText="Check">
            <HeaderStyle CssClass="frm-lft-clr123" HorizontalAlign="Left"/> 
            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="frm-rght-clr1234" Width="5%"/> 
            <ItemTemplate>
...
<tr>
<td width="95%" valign="top" class="pop-tp-clr" align="left">Pick Employee</td>
<td width="5%" align="right" valign="top" class="pop-tp-clr"><a href="#" onclick="document.getElementById('divdetail').style.display='none';" class="pop-tp-clr">
    <asp:ImageButton ID="img_close" runat="server" ImageUrl="~/images/btn-close.gif"
        OnClick="img_close_Click" ValidationGroup="close" /></a></td>
</tr>
<tr>
...
<td colspan="3" valign="top" width="100%">
 <div id="divscrol" runat="server" style="position:static;width:480px; height:450px;overflow-x:hidden;overflow-y:scroll; left: 1px; top: 3px;" >

<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td class="frm-lft-clr123" width="19%">Employee Name</td >
      <td class="frm-rght-clr123" width="30%"><asp:TextBox ID="txtempcode" runat="server"  CssClass="input" Width="140"></asp:TextBox></td>
      ...
      <td class="frm-rght-clr123" width="32%">
            <asp:DropDownList ID="dd_designation" runat="server"
                CssClass="select2" DataSourceID="SqlDataSource1" DataTextField="designationname" DataValueField="id" OnDataBound="dd_designation_DataBound" Width="140px">
            </asp:DropDownList>            
       ...
       <td class="frm-rght-clr123">
            <asp:DropDownList ID="dd_branch" runat="server"
                CssClass="select2" DataSourceID="SqlDataSource2" DataTextField="department_name" DataValueField="departmentid" OnDataBound="dd_branch_DataBound" Width="140px">
            </asp:DropDownList>
       ...
       <tr>
       <td width="9%" colspan="2" align="right"><asp:Button ID="btn_search" runat="server" CssClass="button" Text="Search" OnClick="btn_search_click" ValidationGroup="search" /></td>
       </tr>
 </table>

<asp:GridView ID="adjustgrid" runat="server" Font-Size="11px" Font-Names="Arial" DataKeyNames="empcode" CellPadding="4" Width="100%" AutoGenerateColumns="False" BorderWidth="0px"  
EmptyDataText="No Emp record found" OnRowDataBound="adjustgrid_RowDataBound" OnRowCreated="adjustgrid_RowCreated">
                   <Columns>
...
<td height="20" colspan="3" align="right" valign="middle">
    <asp:Button ID="btn_ok" runat="server" CssClass="button" Text="Add" OnClick="btn_ok_Click" ValidationGroup="no" />
    <asp:Button ID="btn_close" runat="server" CssClass="button" Text="Close" OnClick="btn_close_Click" ValidationGroup="no" />
</td>
</tr>
</table></td>
</tr>

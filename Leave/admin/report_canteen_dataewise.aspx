<%@ Page Language="C#" AutoEventWireup="true" CodeFile="report_canteen_dataewise.aspx.cs" Inherits="leave_report_leaveregister" %>
...
<td width="97%" class="txt01" style="height: 16px">Reports</td>
</tr>
</table></td>
</tr>
<tr>
<td valign="top"><fieldset>
<legend><b>Canteen</b></legend>
...
<td align="right" width="75%" style="height: 20px"><a class="txt-red" href="leaveadmin.aspx" target="name123">
                    Back</a></td>
</tr>
</table></td>
</tr>
...
<td valign="top">&nbsp;<asp:GridView ID="attendancegrid" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Lunch">
                        ...
                        <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top" Width="15%" />
                        <ItemTemplate>
                            <asp:Label ID="l4" runat="server"  Text='<%# Bind("Lunch")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
...
<tr>
<td valign="top" align="right"><a class="txt-red" href="leaveadmin.aspx" target="name123">
                    Back</a></td>
</tr>
</table></td>
</tr>

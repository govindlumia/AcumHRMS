<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showerrorReport.aspx.cs"
    Inherits="leave_admin_showerrorReport" %>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="frm-lft-clr123" colspan="4">
                                            <fieldset>
                                                <legend><b>Error Attendance Criteria</b></legend>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="frm-rght-clr123">
                                                            <asp:RadioButton ID="rbmthan" runat="server" Checked="True" GroupName="e" Text="More than 9Hours" />&nbsp;&nbsp;
                                                            | &nbsp;&nbsp;<asp:RadioButton ID="rbshift" runat="server" GroupName="e" Text="Shift Within 19 Hours" />&nbsp;&nbsp;
                                                            | &nbsp;&nbsp;<asp:RadioButton ID="rbweekoff" runat="server" GroupName="e" Text="Week Off Card Puntch" />&nbsp;&nbsp;
                                                            | &nbsp;&nbsp;<asp:RadioButton ID="rbholiday" runat="server" GroupName="e" Text="Holidays Card Puntch" />&nbsp;&nbsp;
                                                            | &nbsp;&nbsp;<asp:RadioButton ID="rbothrs" runat="server" GroupName="e" Text="Others" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </fieldset>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="27%" class="txt02" style="height: 13px">
                                                        View Attendance Error Report</td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateleave.aspx.cs" Inherits="leave_admin_updateleave" Title="Update Leave" %>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="75%" class="frm-rght-clr123">
                  ...
                  <asp:TextBox ID="txt_leave_type"  MaxLength="20" CssClass="input2" runat="server" ToolTip="Leave Name"></asp:TextBox>
            ...
            <tr>
              ...
              <td width="75%" class="frm-rght-clr123">
                  <asp:Button ID="btnsbmit" runat="server" Text="Submit" CssClass="button" OnClick="btnsbmit_Click" ValidationGroup="v" ToolTip="Click to submit the updated leave" />

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_leave_clubbing_rule.aspx.cs" Inherits="Leave_admin_create_leave_clubbing_rule" Title="Leave Clubbing Rule" %>
    ...
    <td valign="top" class="blue-brdr-1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" class="blue-brdr-1"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="5%"><img src="../images/employee-icon.jpg" width="16" height="16" /></td>
            <td width="95%" class="txt01">
                View Leave Clubbing Rule</td>
            </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <asp:GridView ID="grid_aleave" runat="server" AutoGenerateColumns="False" BorderWidth="1px"
                CellPadding="4" CellSpacing="0" DataKeyNames="aleaveid" Font-Names="Arial" Font-Size="11px"  Width="100%" EmptyDataText="No clubbing rule defined">
                <Columns>                   

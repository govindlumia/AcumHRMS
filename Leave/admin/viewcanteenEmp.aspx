<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewcanteenEmp.aspx.cs" Inherits="leave_admin_viewattendance" %>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
              <td valign="bottom" class="txt02"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                     <tr>
                       <td width="27%" class="txt02" style="height: 13px">View Canteen</td>

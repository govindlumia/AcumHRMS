<%@ Page Language="C#" AutoEventWireup="true" CodeFile="canteancostview.aspx.cs" Inherits="leave_admin_canteancostview" %>
           ...
           <td height="20" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
                 <td align="left" class="txt-red" colspan="2">
                     &nbsp;Coupan Meal Master for Employee&nbsp;View</td>
             </tr>
           </table></td>
          </tr>
                ...
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="75%"class="frm-rght-clr123">
                        &nbsp;
                        <asp:Label ID="lblbreakfast" runat="server"></asp:Label></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td width="75%" class="frm-rght-clr123">
                        &nbsp;
                        <asp:Label ID="lblmeal" runat="server"></asp:Label></td>
                  </tr>

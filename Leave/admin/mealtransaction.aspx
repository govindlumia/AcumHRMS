<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mealtransaction.aspx.cs" Inherits="leave_admin_mealtransaction" %>
           ...
           <td height="20" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
                 <td align="left" class="txt-red" colspan="2">
                     &nbsp;Coupan Transaction for Employee&nbsp;</td>
             </tr>
           </table></td>
          </tr>
                ...
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <td width="75%" class="frm-rght-clr123">
                          <asp:Button ID="btnbreakfst" runat="server" Text="Breakfast" CssClass="button" OnClick="btnbreakfst_Click" ValidationGroup="v" ToolTip="Click here to breakfast coupan" />&nbsp;
                          <asp:Button ID="Button1" runat="server" Text="Main Meal" CssClass="button" OnClick="Button1_Click" ValidationGroup="v" ToolTip="Click here to Main Meal coupan" />

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ODReportForm.aspx.cs" Inherits="leave_admin_ODReportForm" %>
...
<table width="718" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
   ...
   <%-- <cc1:CalendarExtender ID="cextender" runat="server" PopupButtonID="img_f" TargetControlID="txt_sdate" Format="MM/dd/yyyy"></cc1:CalendarExtender>--%>
                 <cc1:CalendarExtender ID="cextender" runat="server" PopupButtonID="img_f" TargetControlID="txt_sdate" Format="dd-MMM-yyy"></cc1:CalendarExtender>
            </td>
                 <td class="frm-lft-clr123" width="20%">
                     &nbsp;To Date</td>
              <td class="frm-rght-clr123" width="30%">
                  &nbsp;<asp:TextBox ID="txt_edate" runat="server" CssClass="select"></asp:TextBox><asp:Image ID="img_e" runat="server" ImageUrl="~/leave/images/clndr.gif" /><asp:RequiredFieldValidator
                          ...
                          ValidationGroup="c"></asp:RequiredFieldValidator><asp:CompareValidator ID="CompareValidator1"
                              runat="server" ControlToValidate="txt_edate" Display="Dynamic" ErrorMessage="Check date format(dd-MMM-yyyy)"
                              Operator="DataTypeCheck" Type="Date" ValidationGroup="c" ValueToCompare="dd-MMM-yyyy"></asp:CompareValidator>
                  <cc1:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="img_e" TargetControlID="txt_edate" Format="dd-MMM-yyy">
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
              <td valign="bottom" class="txt02"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                     <tr>
                       <td width="27%" class="txt02" style="height: 13px">View OD</td>

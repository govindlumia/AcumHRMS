<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AttendenceManually.aspx.cs" Inherits="Leave_admin_AttendenceManually" %>
                                    ...
                                    <td valign="top" class="blue-brdr-1">
                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td id="Td1" class="txt01" runat="server" style="width: 347px; height: 16px">Upload Attendance  <%--Process Attendance for Salary--%></td>
                                ...
                                <tr>
                                    <td valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <td align="left" colspan="2" class="frm-rght-clr123" style="width: 572px">&nbsp;<asp:DropDownList ID="ddlcompany_new" runat="server" CssClass="select"
                                                   ...
                                                   <%-- <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="ddlcompany_new"
                                                    ...
                                                    <asp:RequiredFieldValidator
                                                        ID="rdCompany" runat="server" ControlToValidate="ddlcompany_new" Display="Dynamic" ErrorMessage="Select Company"
                                                        ToolTip="Select Company" ValidationGroup="v1"><img src="../../images/error1.gif" InitialValue="0" alt="Select Company" /></asp:RequiredFieldValidator>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="2" class="frm-rght-clr123" style="width: 572px">&nbsp;<asp:DropDownList ID="ddlbranch" runat="server" CssClass="select"
                                                    ...
                                                    Width="140px">
                                                     ...
                                                     <asp:RequiredFieldValidator
                                                         ID="rdCategory" runat="server" ControlToValidate="ddlbranch" Display="Dynamic" ErrorMessage="Select Category"
                                                         ToolTip="Select Category" ValidationGroup="v1"><img src="../../images/error1.gif" InitialValue="0" alt="Select Category" /></asp:RequiredFieldValidator>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <div id="processattendance" runat="server" style="display: none;">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" class="frm-rght-clr123">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="fupload"
                                                        ...
                                                        ValidationExpression="^.+(.xls|.XLS|.xlsx|.XLSX)$" ValidationGroup="v1"><img src="../../images/error1.gif" alt="File not supported" /></asp:RegularExpressionValidator>
                                                    <asp:RequiredFieldValidator

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="create_leave_adjustment_rule.aspx.cs" Inherits="Leave_admin_create_leave_adjustment_rule" Title="Leave Adjustment Rule" %>
    ...
    <td valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" class="blue-brdr-1"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td class="txt01">Leave Adjustment Rule</td>
            </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
            <td width="24%" class="frm-lft-clr123">Policy Name (<img src="../images/error1.gif" alt="" />)</td>
          ...
          <tr>
            <td width="24%" class="frm-lft-clr123">Leave Name (<img src="../images/error1.gif" alt="" />)</td>
            <td width="76%" class="frm-rght-clr123">
                <asp:DropDownList ID="drp_leave" runat="server" CssClass="select1" OnDataBound="drp_leave_DataBound" DataSourceID="SqlDataSource1" DataTextField="leavetype" DataValueField="leaveid" AutoPostBack="True" Width="120px">
                </asp:DropDownList>
                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="drp_leave"
                  Display="Dynamic" ErrorMessage='<img src="../images/error1.gif" alt="Select Leave" />' ToolTip="Select Leave Name" Operator="NotEqual" ValueToCompare="0" ValidationGroup="v"></asp:CompareValidator>
                </td>
            </tr>
          <tr>
          ...
          <tr>
              <td height="20" valign="top" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                    <td width="27%" class="txt02">Adjust Leave</td>
                    <td width="73%" class="txt-red" align="right"><span id="message1" runat="server"></span>&nbsp;</td>
              </tr>
              </table></td>
          </tr>
      </table></td>
        ...
        <td height="10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="76%" class="frm-rght-clr123"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><asp:DropDownList ID="drp_aleave" runat="server" CssClass="select1" OnDataBound="drp_aleave_DataBound" DataSourceID="SqlDataSource1" DataTextField="leavetype" DataValueField="leaveid" Width="120px">
                </asp:DropDownList>
                    <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="drp_aleave"
                        ...
                        ToolTip="Select Leave Name" ValueToCompare="100"></asp:CompareValidator></td>
      ...
      <tr>
        <td align="right" valign="top" style="height: 18px">
            <asp:Button ID="btn_submit" runat="server" CssClass="button" Text="Submit" OnClick="btn_submit_Click" ValidationGroup="v" />&nbsp;
      ...
      <tr>
        <td valign="top">
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>" ProviderName="<%$ ConnectionStrings:RossellConnectionString.ProviderName %>" SelectCommand="SELECT tbl_leave_createleave.leavetype, tbl_leave_createleave.leaveid, tbl_leave_createdefaultrule.leaveid AS Expr1, tbl_leave_createdefaultrule.policyid FROM tbl_leave_createdefaultrule INNER JOIN tbl_leave_createleave ON tbl_leave_createdefaultrule.leaveid = tbl_leave_createleave.leaveid WHERE (tbl_leave_createdefaultrule.policyid = @policyid) and tbl_leave_createdefaultrule.leaveid<>0">
                <SelectParameters>

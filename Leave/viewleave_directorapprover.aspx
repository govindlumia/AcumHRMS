<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewleave_directorapprover.aspx.cs" Inherits="Leave_viewleave_directorapprover" %>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td width="100%" class="head-2" valign="top">
                    <asp:GridView ID="grdMyBalance" BorderWidth="0" runat="server" Font-Size="11px" Font-Names="Arial"
                        CellPadding="4" Width="100%" EmptyDataText="No Leave profile created.." GridLines="None">

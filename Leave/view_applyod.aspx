<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_applyod.aspx.cs" Inherits="leave_view_applyod" %>
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="10" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td class="frm-rght-clr123"><asp:Label ID="lbl_date" runat="server" Text="Label"></asp:Label></td>
          </tr>
          <tr>
            <td height="5" colspan="2"></td>
          </tr>
           <tr>
            ...
            <td class="frm-rght-clr123"><asp:Label ID="lbl_ftime" runat="server" Text="Label"></asp:Label></td>
          </tr>
          <tr>
            <td height="5" colspan="2"></td>
          </tr>
          ...
          <tr>
            <td class="frm-lft-clr123">
                Mode</td>
            <td class="frm-rght-clr123"><asp:Label ID="lbl_half" runat="server" Text="Label"></asp:Label></td>
          </tr>
          <tr>
        ...
        <tr>
            ...
            <td class="frm-rght-clr123"><asp:TextBox ID="txt_comment" runat="server" CssClass="input"></asp:TextBox></td>
          </tr>
          <tr>
            <td colspan="2" ></td>
          </tr>
      ...
      <tr>
        <td valign="top" align="right">
            <asp:Button ID="btn" runat="server" CssClass="button" OnClick="btn_Click" Text="Back" />&nbsp;<asp:Button ID="btn_cancel" runat="server" CssClass="button" OnClick="btn_cancel_Click"
                Text="Cancel OD" /></td>
      </tr>
    </table></td>
  </tr>

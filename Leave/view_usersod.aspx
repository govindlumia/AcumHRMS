<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_usersod.aspx.cs" Inherits="leave_view_usersod" %>
    ...
    <td valign="top" height="463px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
            <td valign="top" class="txt02" height="20">&nbsp;View Pending OD</td>
            <td valign="top" class="txt-red" align="right"><span id="message" runat="server"></span>&nbsp;</td>
            </tr>
            </table>
            </td>
            </tr>
                ...
                <Columns> 
                    ...
                    <asp:TemplateField HeaderText="From Date" HeaderStyle-HorizontalAlign="Left">
                     ...
                     <asp:TemplateField HeaderText="Days" HeaderStyle-HorizontalAlign="left">
                      ...
                      <asp:TemplateField HeaderText="OD Status" HeaderStyle-HorizontalAlign="Left">
                        ...
                        <ItemStyle CssClass="frm-rght-clr1234"  HorizontalAlign="Left"
                            VerticalAlign="Top" Width="17%" />
                        <ItemTemplate>
                            <asp:Label ID="l3" runat="server" Text="Pending" ></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField> 
                     ...
                     <asp:TemplateField>
                        ...
                        <ItemTemplate>
                          <a class="link05" href="view_applyod.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>&empcode=<%#DataBinder.Eval(Container.DataItem,"empcode")%>"
                                target="_self">View</a> |
                         <a class="link05" href="edit_applyod.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>&empcode=<%#DataBinder.Eval(Container.DataItem,"empcode") %>"
                                target="_self">Edit</a> 
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>

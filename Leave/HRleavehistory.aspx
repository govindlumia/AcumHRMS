<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRleavehistory.aspx.cs" Inherits="Leave_HRleavehistory" %>
                                    ...
                                    <RowStyle Height="5px" />
                                     ...
                                     <asp:TemplateField HeaderText="Emp Code">
                                        ...
                                        <asp:TemplateField HeaderText="Leave Type">
                                            ...
                                            <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top" />
                                            <ItemTemplate>
                                                <%#linkleave(DataBinder.Eval(Container.DataItem, "empcode").ToString(), DataBinder.Eval(Container.DataItem, "leavename").ToString(), Convert.ToInt32(DataBinder.Eval(Container.DataItem, "id")), Convert.ToInt32(DataBinder.Eval(Container.DataItem, "status")))%>
                                            </ItemTemplate>
                                        </asp:TemplateField>

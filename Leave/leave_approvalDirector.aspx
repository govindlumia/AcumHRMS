<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leave_approvalDirector.aspx.cs" Inherits="Leave_leave_approvalDirector" %>
            ...
            <tr>
                <td valign="top">
                        ...
                        <tr>
                            <td valign="top" class="head-2" style="height: 10px">
                                <asp:GridView ID="leave_approval_grid" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    EmptyDataText="No Data Available !" DataSourceID="SqlDataSource1" DataKeyNames="id">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:RossellConnectionString %>"
                        runat="server" SelectCommand="sp_leave_fetchleavesummaryDirector" SelectCommandType="StoredProcedure">
                        <SelectParameters>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approveot.aspx.cs" Inherits="leave_admin_approveot" %>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <%-- <asp:TemplateField HeaderText="Employee Code">
            ...
            <asp:TemplateField HeaderText="">
                ...
                <ItemStyle Width="35%" />
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="Server" CommandName=""  Text="View" CssClass="link05" /> | 
...
<tr>
<td width="95%" valign="top" class="pop-tp-clr" align="left" style="height: 19px"> </td>
<td width="5%" align="right" valign="top" class="pop-tp-clr" style="height: 19px"><a href="#" onclick="document.getElementById('light').style.display='none';"><img src="images/btn-close.gif" width="16" height="19" border="0" /></a></td>
</tr>
<tr>
<td colspan="2" height="10"></td>
</tr>
<tr>
<td colspan="2" align="center" valign="top"><iframe src="my_balance_leave.aspx" frameborder="0" scrolling="yes" width="600" height="250"></iframe></td>
</tr>
<tr>
<td colspan="2" height="10"></td>
</tr>

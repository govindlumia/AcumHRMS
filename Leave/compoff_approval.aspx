<%@ Page Language="C#" AutoEventWireup="true" CodeFile="compoff_approval.aspx.cs"
    Inherits="leave_leave_approval" %>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="l4" runat="server" Text='<%# Bind("leavestatus") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="From Date">
                                            ...
                                            <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top" />
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_fromdate" runat="server" Text='<%# Bind("fromdate") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="To Date">
                                            ...
                                            <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top" />
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_todate" runat="server" Text='<%# Bind("todate") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewleave_hr_cancel.aspx.cs" Inherits="leave_viewleave_hr_cancel" %>
 ...
 <tr>
      ...
      <tr>
        <td align="right" valign="top" style="height: 18px">
            ...
            <asp:Button ID="btn_reset" runat="server" CssClass="button" Text="Reset" OnClick="btn_reset_Click" Visible="False" />&nbsp;<asp:Button ID="btncancel" runat="server" CssClass="button" Text="Cancel" OnClick="btncancel_Click" />&nbsp;
        </td>
      </tr>
      <tr>

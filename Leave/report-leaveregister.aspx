<%@ Page Language="C#" AutoEventWireup="true" CodeFile="report-leaveregister.aspx.cs"
...
<body>
    ...
    <Triggers>
    <asp:PostBackTrigger ControlID="btn_toexcel" />
    </Triggers>
        <ContentTemplate>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td width="97%" class="txt01">
                                                                   ...
                                                                   <asp:ListItem Value="0">Leave Details Summary</asp:ListItem>
                                                                   <asp:ListItem Value="1">Leave Details  </asp:ListItem>
                                                                   </asp:RadioButtonList>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr>
                                                    <td valign="top" id="leavedetails" runat="server" >
                                                        <fieldset>
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="19%" valign="top" class="frm-rght-clr123">
                                                                        <asp:DropDownList ID="dd_company" runat="server" CssClass="select2" AutoPostBack="true"
                                                                            Width="150px">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td valign="top" class="frm-rght-clr123">
                                                                        <asp:TextBox ID="txt_employee" runat="server" CssClass="input" Enabled="False"></asp:TextBox>
                                                                        ...
                                                                        <a href="JavaScript:newPopup1('../pickempwithdata.aspx?HR=0&MSS=0&Emp=1&Con=txt_employee');" class="link05">
                                                                            Pick Employee</a>&nbsp;
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="5" valign="top">
                                                                        ...
                                                                        <asp:Button ID="Button1" runat="server" onclick="btn_view_Click" Text="Calender View" />

                                                                        <span style="padding-left: 200px">
                                                                            <asp:Calendar ID="Calendar1" runat="server"></asp:Calendar>
                                                                            <asp:Button runat="server" ID="btn_toexcel" CssClass="button2" Text="Export To Excel" OnClick="btn_toexcel_Click"
                                                                                ValidationGroup="c" />
                                                                        </span>
                                                                    </td>
                                                                </tr>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        &nbsp;<asp:GridView ID="empleavegrid" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                            ...
                                                            OnRowDataBound="empleavegrid_RowDataBound" PageSize="50" Width="100%">
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="From">
                                                                    ...
                                                                    <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top"
                                                                        Width="10%" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="fromdate" runat="server" Text='<%# Bind ("fromdate") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="To">
                                                                    ...
                                                                    <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top"
                                                                        Width="10%" />
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="todate" runat="server" Text='<%# Bind ("todate") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                ...
                                                <tr>
                                                    <td valign="top" id="divleavesummary" runat="server" >
                                                        <fieldset>
                                                            <legend><b>Leave Details Summary</b></legend>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                        ...
                                                                        <div id="Div1" runat="server" visible="true">
                                                                            <table  width="100%" cellpadding="0" cellspacing="0">
                                                                                 ...
                                                                                 <tr>
                                                                                    ...
                                                                                    <td valign="top" class="frm-rght-clr123" width="19%">
                                                                                        <asp:DropDownList ID="dd_month" runat="server" CssClass="select" AutoPostBack="False"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="19%" valign="top" class="frm-rght-clr123">
                                                                        <asp:DropDownList ID="ddlcompany" runat="server" CssClass="select2" AutoPostBack="true"
                                                                            Width="150px">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td valign="top" class="frm-rght-clr123">
                                                                        <asp:TextBox ID="txtempsummary" runat="server" CssClass="input" Enabled="False"></asp:TextBox>
                                                                        <%--   <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="link05"
                                                                            ValidationGroup="noone">Pick</asp:LinkButton>--%>
                                                                        <a href="JavaScript:newPopup1('../pickempwithdata.aspx?HR=0&MSS=0&Emp=1&Con=txtempsummary');" class="link05">
                                                                            Pick Employee</a>&nbsp;
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td colspan="5" valign="top">
                                                                        <asp:Button ID="btnsearchsummary" runat="server" CssClass="button" OnClick="btnsearchsummary_Click"
                                                                            Text="Search" />
                                                                            <asp:Button id="btnexporttoexcel" runat="server"  CssClass="button" Text="Export" OnClick="btnexporttoexcel_Click"
                                                                                 />
                                                                    </td>
                                                                </tr>
                                                                   <tr>
                                                                   ...
                                                                   <tr>
                                                                    <td colspan="5">
                                                                        <asp:GridView ID="Gridleavedetailssummary" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                            BorderWidth="0px" CellPadding="4" CellSpacing="0" DataKeyNames="empcode" EmptyDataText="No employee leave data found!"
                                                            Font-Names="Arial" Font-Size="11px" OnPageIndexChanging="Gridleavedetailssummary_PageIndexChanging"
                                                            OnRowDataBound="Gridleavedetailssummary_RowDataBound" PageSize="50" Width="100%">
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="From">
                                                                    <HeaderStyle CssClass="frm-lft-clr123" Width="10%" HorizontalAlign="Left" />
                                                                    <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" VerticalAlign="Top"
                                                                    ...
                                                                    <asp:GridView ID="adjustgrid" runat="server" Font-Size="11px" Font-Names="Arial"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Emp Name">
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="l3" runat="server" Text='<%# Bind ("ename") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                        </Columns>
                                                                        <FooterStyle CssClass="frm-lft-clr123" />

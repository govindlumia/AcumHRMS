            ...
            <div>
                        ...
                        <td valign="top" class="blue-brdr-1">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td class="txt01">
                                        Apply Leave
                                        <span style="color: red"> <asp:Label ID="lbl_emp_statusmsg" runat="server" Visible="false" Text="lbl_emp_statusmsg"></asp:Label>&nbsp;</span>
                                 ...
                                 <%--   <td width="18%" class="frm-lft-clr123">
                                    ...
                                    <td width="31%" class="frm-rght-clr123">
                                       <%-- <asp:Label ID="lbl_branch" runat="server" Text="Label"></asp:Label>--%>
                                        ...
                                        <%--added label lbl_emp_confirmStatus for using this later for confirm/probation checking By Keerti Dwivedi on 27th May 2018 --%>
                                                                                <asp:Label ID="lbl_emp_confirmStatus" runat="server" Visible="false" Text="Label"></asp:Label>&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="height: 5px">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td class="frm-rght-clr123">
                                                    <asp:DropDownList ID="dd_typeleave" runat="server" CssClass="select" 
                                                ...
                                                <td width="31%" class="frm-rght-clr123">
                                                    <asp:TextBox ID="txt_MobileNo" runat="server" ToolTip="Emergency contact number"
                                                        CssClass="blue1" Width="142px" onblur="javascript:if(this.value.length<10){alert('number must be of 10 digits');this.value='';this.focus();}" onkeyup="ValidateText(this)" MaxLength="10"></asp:TextBox>
                                           ...
                                           <%-- <td class="frm-lft-clr123" width="19%">
                                            ...
                                            <td width="31%" class="frm-rght-clr123">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvDir" runat="server" ControlToValidate="ddlDirector"
                                                    Display="None" ErrorMessage="Please Select Director" InitialValue="0"
                                                    ...
                                                    <tr>
                                                        <td >
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txt_employee"
                                                                ErrorMessage="Please Pick Responsible Person" Display="none"
                        ...
                        <tr>
                            <td class="head-2" valign="top" colspan="2">
                                <asp:GridView ID="approvergrid" runat="server" Font-Size="11px" Font-Names="Arial"
                                    ...
                                    onselectedindexchanged="approvergrid_SelectedIndexChanged">
                                    <Columns>
                ...
                <tr>
                    <td align="right" valign="top">
                        ...
                        <asp:Button ID="btn_draft" runat="server" ValidationGroup="a" CssClass="button" Text="Save Draft"
                            OnClick="btn_draftl_Click" />&nbsp;
                    </td>
                </tr>
                <tr>
                    <td valign="top">

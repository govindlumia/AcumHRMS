...
public partial class TimeSheet_User_ProjectReportForAdmin : System.Web.UI.Page
{
    ...
    public static List<string> AutoComplete_Project_ForAdmin(string prefixText, int count, string contextKey)
    {
        MyTimeSheetBussiness balObj = new MyTimeSheetBussiness();

        DataTable dt = balObj.getProjectListForAdmin(prefixText, contextKey);
    ...
    public static List<string> AutoComplete_Employee_ForAdmin(string prefixText, int count, string contextKey)
    {
        ReportsBussiness balObj = new ReportsBussiness();

        DataTable dt = balObj.getEmployeeList(prefixText);
    ...
    protected void btn_view_Click(object sender, EventArgs e)
    {
        ...
        ReportsBussiness balObj = new ReportsBussiness();
        DataTable dt_result = balObj.projectReportForAdmin(txt_employee.Text.Trim(), txt_project.Text.Trim(), chk_Isapprove.Checked ? true : false, Session["EmpCode"].ToString(), fromDate, toDate,chk_past_emp.Checked);
    ...
    private void exportToExcel(object file)
    {
        ...
        string attachment = "attachment;   filename=ProjectReportForAdmin.xls";
    ...
    protected void btn_export_excel_Click(object sender, EventArgs e)
    {
        ...
        if (grd_report.Rows.Count > 0)
        {
            ...
            cell2.Text = "Project Report For Admin";
            cell2.Style["text-align"] = "left";
            cell2.ColumnSpan = dt_result.Columns.Count - 1;
            row.Cells.Add(cell1);
            row.Cells.Add(cell2);

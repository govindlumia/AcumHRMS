<%@ Page Title="" Language="C#" MasterPageFile="~/TimeSheet/User/TimesheetUser.master" AutoEventWireup="true" CodeFile="ViewEmployeeTimeSheet.aspx.cs" Inherits="TimeSheet_User_ViewEmployeeTimeSheet" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <script type="text/javascript">
       function checkComment() {
           ...
           if (txt_comment.value == "" && txt_comment != null) {
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                            ...
                            <td class="blue-brdr-1">
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                        ...
                                        <td class="frm-lft-clr123" width="45%">
                                      For Week   <asp:Label runat="server" ID="lbl_fromweek"></asp:Label>
                                      to <asp:Label runat="server" ID="lbl_toweek"></asp:Label>
                                        </td>
                                        <td class="frm-lft-clr123">
                                         <asp:Label ID="lbl_week_hide" runat="server" Visible="false"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GrdViewTimeSheet" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    ShowFooter="true" EmptyDataText="No Record(s) found" 
                                    onrowdatabound="GrdViewTimeSheet_RowDataBound">
                                    <Columns>
                   ...
                   <td colspan="2">
                        <asp:Button ID="btn_approve" runat="server" CssClass="button" Text="Approve" 
                            onclick="btn_approve_Click" OnClientClick="return checkComment();" />
                        <span style="padding-left:40px">     <asp:Button ID="btn_reject" runat="server" 
                            CssClass="button" Text="Reject" onclick="btn_reject_Click" OnClientClick="return checkComment();" /></span>
                   </td>
                    </tr>
                     </table>
                        </td>

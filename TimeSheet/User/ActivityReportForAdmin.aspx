<%@ Page Title="" Language="C#" MasterPageFile="~/TimeSheet/User/TimesheetUser.master" AutoEventWireup="true" CodeFile="ActivityReportForAdmin.aspx.cs" Inherits="TimeSheet_User_ActivityReportForAdmin" %>
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                        <td class="txt01">
                                            ...
                                            Activity Wise Report For Admin
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        ...
                                                                        <Ajax:AutoCompleteExtender runat="server" ID="ACE_txt_project" MinimumPrefixLength="1"
                                                                            ...
                                                                            CompletionListHighlightedItemCssClass="itemHighlighted" ServicePath="ProjectReportForAdmin.aspx" 
                                                                            CompletionListCssClass="completionList" CompletionListItemCssClass="listItem" UseContextKey="true"
                                                                            ServiceMethod="AutoComplete_Project_ForAdmin" >
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        ...
                                                                        <Ajax:AutoCompleteExtender runat="server" ID="ACE_txt_employee" MinimumPrefixLength="1"
                                                                            ...
                                                                            CompletionListHighlightedItemCssClass="itemHighlighted"  ServicePath="ProjectReportForAdmin.aspx"
                                                                            CompletionListCssClass="completionList" CompletionListItemCssClass="listItem" UseContextKey="true"
                                                                            ServiceMethod="AutoComplete_Employee_ForAdmin" >
                                                                        </Ajax:AutoCompleteExtender>
                                                                    </td>
                                                                </tr>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Button ID="btn_view" runat="server" Text="View" CssClass="button" ValidationGroup="vg_main"
                                                                                        ...
                                                                                        <span>
                                                                                        <asp:Button runat="server" CssClass="button" Text="clear" ID="btn_clearall" 

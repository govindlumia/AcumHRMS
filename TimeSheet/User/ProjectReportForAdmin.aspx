<%@ Page Title="" Language="C#" MasterPageFile="~/TimeSheet/User/TimesheetUser.master"
    AutoEventWireup="true" CodeFile="ProjectReportForAdmin.aspx.cs" Inherits="TimeSheet_User_ProjectReportForAdmin" %>
        ...
        <ContentTemplate>
            <div id="HomePage" runat="server">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        <asp:TextBox runat="server" ID="txt_project" OnTextChanged="txt_employee_TextChanged"></asp:TextBox>
                                                                        <Ajax:AutoCompleteExtender runat="server" ID="ACE_txt_project" MinimumPrefixLength="1"
                                                                            CompletionSetCount="10" CompletionInterval="200" TargetControlID="txt_project"
                                                                            CompletionListHighlightedItemCssClass="itemHighlighted" CompletionListCssClass="completionList"
                                                                            CompletionListItemCssClass="listItem" UseContextKey="true" ServiceMethod="AutoComplete_Project_ForAdmin">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        <asp:TextBox runat="server" ID="txt_employee" OnTextChanged="txt_employee_TextChanged"></asp:TextBox>
                                                                        <Ajax:AutoCompleteExtender runat="server" ID="ACE_txt_employee" MinimumPrefixLength="1"
                                                                            ...
                                                                            CompletionListHighlightedItemCssClass="itemHighlighted" CompletionListCssClass="completionList"
                                                                            CompletionListItemCssClass="listItem" UseContextKey="true" ServiceMethod="AutoComplete_Employee_ForAdmin">
                                                                        </Ajax:AutoCompleteExtender>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Button ID="btn_view" runat="server" Text="View" CssClass="button" ValidationGroup="vg_main"
                                                                                        ...
                                                                                        <span>
                                                                                       <asp:Button runat="server" Text="Clear" ID="btn_clearall" CssClass="Button" 
                                                ...
                                                <td>
                                                    <div id="dvResult" style="overflow: scroll; height: 490px; border: 0px #000 solid;"
                                                        ...
                                                        <asp:GridView ID="grd_report" runat="server" AllowPaging="True" Width="100%" HorizontalAlign="Left"
                                                            ...
                                                            PageSize="25" GridLines="Both" BorderWidth="1px" BorderColor="#c9dffb" EmptyDataText="No Data Found"
                ...
                <div style="float: right; padding-right: 40px">
                    <asp:Button runat="server" ID="btn_export_excel" Text="Export To Excel" CssClass="button2"
                        OnClick="btn_export_excel_Click"></asp:Button>
                </div>
            </div>
            <div>

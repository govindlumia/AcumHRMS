...
public partial class TimeSheet_User_ActivityReportForAdmin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["EmpCode"] != null)
            ACE_txt_project.ContextKey = Session["EmpCode"].ToString();
        else
    ...
    protected void btn_view_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt_result = balObj.ActivityReportForAdmin(txt_project.Text.Trim(), txt_employee.Text.Trim(), Session["EmpCode"].ToString(), chk_Isapprove.Checked ? true : false, fromDate, toDate,chk_past_emp.Checked);
        if (dt_result.Rows.Count > 0)
        {
            if (dt_result.Rows[0][0].Equals("No Project"))
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "nopro", "alert('No Project with this Name');", true);
                txt_project.Text = "";
                return;
            }
    ...
    private void exportToExcel(object file)
    {
        ...
        string attachment = "attachment;   filename=ActivityReportForAdmin.xls";
    ...
    protected void btn_export_excel_Click(object sender, EventArgs e)
    {
        ...
        if (grd_report.Rows.Count > 0)
        {
            ...
            cell2.Text = "Activity Report For Admin";
            cell2.Style["text-align"] = "left";
            cell2.ColumnSpan = dt_result.Columns.Count - 1;
            row.Cells.Add(cell1);
            row.Cells.Add(cell2);

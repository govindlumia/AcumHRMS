<%@ Page Title="" Language="C#" MasterPageFile="~/TimeSheet/User/TimesheetUser.master" AutoEventWireup="true" CodeFile="ProjectReportForRM.aspx.cs" Inherits="TimeSheet_User_ProjectReportForRM" %>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                           <asp:TextBox runat="server" ID="txt_employee" ClientIDMode="Static"
                                                                             ></asp:TextBox> &nbsp;&nbsp;
                                                            ...
                                                            class="link05">Pick Employee</a>
                                                                     ...
                                                                     <%--   <Ajax:AutoCompleteExtender runat="server" ID="ACE_txt_employee" MinimumPrefixLength="1"
                                                                            ...
                                                                            ServiceMethod="AutoComplete_Employee_For_RM" >

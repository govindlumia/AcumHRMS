<%@ Page Title="" Language="C#" MasterPageFile="~/TimeSheet/User/TimesheetUser.master" AutoEventWireup="true" CodeFile="ActivityReportForRM.aspx.cs" Inherits="TimeSheet_User_ActivityReportForRM" %>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        <asp:TextBox runat="server" ID="txt_Employee" ClientIDMode="Static"></asp:TextBox>&nbsp;&nbsp;
                                                            ...
                                                            class="link05">Pick Employee</a>
                                                                      ...
                                                                      <%--  <Ajax:AutoCompleteExtender runat="server" ID="ACE_txt_Employee" MinimumPrefixLength="1"
                                                                            CompletionSetCount="10" CompletionInterval="1000" TargetControlID="txt_Employee"
                                                                            ServiceMethod="AutoComplete_Employee_For_RM" CompletionListHighlightedItemCssClass="itemHighlighted" 
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                           <asp:TextBox runat="server" ID="txt_project" 
                                                                        ...
                                                                        <Ajax:AutoCompleteExtender runat="server" ID="ACE_txt_project" MinimumPrefixLength="1"
                                                                            ...
                                                                            CompletionListCssClass="completionList" CompletionListItemCssClass="listItem" UseContextKey="true"
                                                                            ServiceMethod="AutoComplete_Project" >
                                                                        </Ajax:AutoCompleteExtender>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        <asp:CheckBox runat="server" ID="chk_past_employee" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2" height="5">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Button ID="btn_view" runat="server" Text="View" CssClass="button" ValidationGroup="vg_main"
                                                                                        ...
                                                                                        CssClass="button" onclick="btn_clear_Click" />
                                                                                        </span>
                                                                                </td>
                                                                            </tr>

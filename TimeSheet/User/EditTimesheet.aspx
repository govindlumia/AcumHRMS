                                    ...
                                    <Columns>
                                      ...
                                      <asp:CheckBox ID="chk_data"  runat="server" />
                                        ...
                                        <asp:TemplateField HeaderText="Comment">
                                            <ItemStyle CssClass="frm-rght-clr1234" HorizontalAlign="Left" Width="45" />
                                            <ItemTemplate>
                                                <asp:TextBox runat="server" ID="txt_comment" ToolTip='<%#bind("ID")%>' Text='<%# bind("UserComment") %>' TextMode="MultiLine" AutoPostBack="true" OnTextChanged="calculateTotal_Click"></asp:TextBox>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                    <tr>
                                        ...
                                        <td width="15%" align="center">
                                            <asp:Button ID="btn_rmv_row" runat="server" CssClass="button2" Text="Remove Row" 

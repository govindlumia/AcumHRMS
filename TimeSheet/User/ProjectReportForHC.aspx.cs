...
public partial class TimeSheet_ProjectReportForHC : System.Web.UI.Page
{
    ...
    protected void btn_view_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt_result = balObj.projectReportForHC(txt_employee.Text.Trim(), txt_project.Text.Trim(), chk_Isapprove.Checked ? true : false, fromDate, toDate,chk_past_emp.Checked);
    ...
    public static List<string> AutoComplete_Employee(string prefixText, int count, string contextKey)
    {
        ReportsBussiness balObj = new ReportsBussiness();
    ...
    //        string filename = "attachment;filename =ProjectReportForHC'"+DateTime.Now+"'.xls";
    ...
    private void exportToExcel(object file)
    {
        ...
        string attachment = "attachment;   filename=ProjectReportForHC.xls";
    ...
    protected void btn_export_excel_Click(object sender, EventArgs e)
    {
        ...
        if (grd_report.Rows.Count > 0)
        {
            ...
            cell2.Text = "Project Report For HC";
            cell2.Style["text-align"] = "left";
            cell2.ColumnSpan = dt_result.Columns.Count - 1;
            row.Cells.Add(cell1);
            row.Cells.Add(cell2);

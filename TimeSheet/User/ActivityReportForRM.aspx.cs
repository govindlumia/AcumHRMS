...
public partial class TimeSheet_User_ActivityReportForRM : System.Web.UI.Page
{
    ...
    protected void btn_view_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt_result = balObj.ActivityReportForRM(txt_Employee.Text.Trim(), txt_project.Text.Trim(), "", chk_Isapprove.Checked ? true : false, Session["EmpCode"].ToString(), fromDate, toDate,chk_past_employee.Checked);
    ...
    private void exportToExcel(object file)
    {
        ...
        string attachment = "attachment;   filename=ActivityReportForRM.xls";
    ...
    protected void btn_export_excel_Click(object sender, EventArgs e)
    {
        ...
        if (grd_report.Rows.Count > 0)
        {
            ...
            cell2.Text = "Activity Report For Reporting Manager";
            cell2.Style["text-align"] = "left";
            cell2.ColumnSpan = dt_result.Columns.Count - 1;
            row.Cells.Add(cell1);
            row.Cells.Add(cell2);
    ...
    protected void btn_clear_Click(object sender, EventArgs e)
    {
        ...
        chk_past_employee.Checked = false;
        grd_report.DataSource = null;
        grd_report.DataBind();
    }
}
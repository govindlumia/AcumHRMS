<%@ Page Title="" Language="C#" MasterPageFile="~/TimeSheet/User/TimesheetUser.master"
    AutoEventWireup="true" CodeFile="ProjectReportForHC.aspx.cs" Inherits="TimeSheet_ProjectReportForHC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        ...
                                                                        <Ajax:AutoCompleteExtender runat="server" ID="AutoCompleteExtender1" MinimumPrefixLength="1"
                                                                            ...
                                                                            CompletionListItemCssClass="listItem" UseContextKey="true" ServiceMethod="AutoComplete_Project">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        ...
                                                                        <Ajax:AutoCompleteExtender runat="server" ID="ACE_txt_employee" MinimumPrefixLength="1"
                                                                            ...
                                                                            CompletionListHighlightedItemCssClass="itemHighlighted" CompletionListCssClass="completionList"
                                                                            CompletionListItemCssClass="listItem" UseContextKey="true" ServiceMethod="AutoComplete_Employee">
                                                                        </Ajax:AutoCompleteExtender>
                                                                    </td>
                                                                </tr>
                                                                <tr>
   ...
   <asp:Button ID="btn_clearall" runat="server" Text="clear" CssClass="button" onclick="btn_clearall_Click" ></asp:Button>
                                                                                </td>
                                                                            </tr>
              ...
              <%--    <asp:Button runat="server" Text="Export Excel" ID="btn_export" CssClass="button" 

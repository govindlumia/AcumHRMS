<%@ Page Title="" Language="C#" MasterPageFile="~/TimeSheet/Admin/TimesheetMaster.master" AutoEventWireup="true" CodeFile="TimesheetStatus.aspx.cs" Inherits="TimeSheet_Admin_TimesheetStatus" %>
            ...
            <div id="HomePage" runat="server">
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div id="createtimesheetstatus" runat="server" style="display: block;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="frm-rght-clr123">
                                                                        <asp:TextBox ID="txt_time_status" MaxLength="50" runat="server" CssClass="blue1" Width="142px"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_time_status"
                                                                            Display="None" SetFocusOnError="True" ToolTip="Enter TimeSheet Status" ValidationGroup="c"
                                                                            ErrorMessage="Enter TimeSheet Status" Width="6px"></asp:RequiredFieldValidator>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                        ...
                        <tr>
                            <td>
                                <div id="viewtimesheetstatus" runat="server" style="display: block;">
                                    <div style="overflow: scroll; height: 490px;">
                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td class="frm-rght-clr123" width="10%">
                                                                <asp:TextBox ID="txt_employee" runat="server" MaxLength="20" CssClass="input" Width="100px"></asp:TextBox>
                                                            </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div id="dvResult" style="overflow: auto; height: 490px; border: 0px #000 solid;"
                                                        runat="server">
                                                        <asp:GridView ID="Grid_empstatus" runat="server" AllowPaging="True" Width="100%" EmptyDataText="No data found(s)"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="TimeSheet Status" SortExpression="SaveMode">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("SaveMode") %>'></asp:Label>
                                                                    </ItemTemplate>

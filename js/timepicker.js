...
var imagePath="";
  ...
  if (dom){
    document.write ("<div id='timepicker' style='z-index:+999;position:absolute;visibility:hidden;'><table style='border-width:3px;border-style:solid;border-color:#0033AA' bgcolor='#ffffff' cellpadding=0><tr bgcolor='#0033AA'><td><table cellpadding=0 cellspacing=0 width='100%' background='" + imagePath + "titleback.gif'><tr valign=bottom height=21><td style='font-family:verdana;font-size:11px;color:#ffffff;padding:3px' valign=center><B>&nbsp;&nbsp;Select a Time&nbsp;&nbsp;</B></td><td><img id='iconAM' src='" + imagePath + "../images/am1.gif' onclick='document.getElementById(\"iconAM\").src=\"" + imagePath + "../images/am1.gif\";document.getElementById(\"iconPM\").src=\"" + imagePath + "../images/pm2.gif\";refreshTimePicker(0)' style='cursor:hand'></td><td><img id='iconPM' src='" + imagePath + "../images/pm2.gif' onclick='document.getElementById(\"iconAM\").src=\"" + imagePath + "../images/am2.gif\";document.getElementById(\"iconPM\").src=\"" + imagePath + "../images/pm1.gif\";refreshTimePicker(1)' style='cursor:hand'></td><td align=right valign=center>&nbsp;<img onclick='closeTimePicker()' src='" + imagePath + "../images/action_delete.gif'  STYLE='cursor:hand'>&nbsp;</td></tr></table></td></tr><tr><td colspan=2><span id='timePickerContent'></span></td></tr></table></div>");
    refreshTimePicker(0);
  }
  ...
  function selectTime(ctl,ctl2) {
    ...
    textCtl=ctl2;
    currentCtl = ctl
 //   currentCtl.src=imagePath+ "clndr.gif";
     currentCtl.src="../images/clndr.gif";

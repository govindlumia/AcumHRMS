...
var selectBoxRolloverBgColor = '#E9F5FF'; // Background color on drop down lists(rollover)
...
{    
    var inputField = document.getElementById(inputField.toString());    
